(function(){const f=document.createElement("link").relList;if(f&&f.supports&&f.supports("modulepreload"))return;for(const m of document.querySelectorAll('link[rel="modulepreload"]'))o(m);new MutationObserver(m=>{for(const v of m)if(v.type==="childList")for(const S of v.addedNodes)S.tagName==="LINK"&&S.rel==="modulepreload"&&o(S)}).observe(document,{childList:!0,subtree:!0});function d(m){const v={};return m.integrity&&(v.integrity=m.integrity),m.referrerPolicy&&(v.referrerPolicy=m.referrerPolicy),m.crossOrigin==="use-credentials"?v.credentials="include":m.crossOrigin==="anonymous"?v.credentials="omit":v.credentials="same-origin",v}function o(m){if(m.ep)return;m.ep=!0;const v=d(m);fetch(m.href,v)}})();function V0(s){return s&&s.__esModule&&Object.prototype.hasOwnProperty.call(s,"default")?s.default:s}var Nc={exports:{}},Rn={};/**
 * @license React
 ...
 */var Mf;function Z0(){if(Mf)return Rn;Mf=1;var s=Symbol.for("react.transitional.element"),f=Symbol.for("react.fragment");function d(o,m,v){var S=null;if(v!==void 0&&(S=""+v),m.key!==void 0&&(S=""+m.key),"key"in m){v={};for(var T in m)T!=="key"&&(v[T]=m[T])}else v=m;return m=v.ref,{$$typeof:s,type:o,key:S,ref:m!==void 0?m:null,props:v}}return Rn.Fragment=f,Rn.jsx=d,Rn.jsxs=d,Rn}var Cf;function K0(){return Cf||(Cf=1,Nc.exports=Z0()),Nc.exports}var i=K0(),wc={exports:{}},te={};/**
 * @license React
 * react.production.js
 *
 * Copyright (c) Meta Platforms, Inc. and affiliates.
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var _f;function J0(){if(_f)return te;_f=1;var s=Symbol.for("react.transitional.element"),f=Symbol.for("react.portal"),d=Symbol.for("react.fragment"),o=Symbol.for("react.strict_mode"),m=Symbol.for("react.profiler"),v=Symbol.for("react.consumer"),S=Symbol.for("react.context"),T=Symbol.for("react.forward_ref"),b=Symbol.for("react.suspense"),p=Symbol.for("react.memo"),w=Symbol.for("react.lazy"),B=Symbol.iterator;function k(x){return x===null||typeof x!="object"?null:(x=B&&x[B]||x["@@iterator"],typeof x=="function"?x:null)}var M={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},Q=Object.assign,H={};function U(x,_,X){this.props=x,this.context=_,this.refs=H,this.updater=X||M}U.prototype.isReactComponent={},U.prototype.setState=function(x,_){if(typeof x!="object"&&typeof x!="function"&&x!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,x,_,"setState")},U.prototype.forceUpdate=function(x){this.updater.enqueueForceUpdate(this,x,"forceUpdate")};function L(){}L.prototype=U.prototype;function G(x,_,X){this.props=x,this.context=_,this.refs=H,this.updater=X||M}var $=G.prototype=new L;$.constructor=G,Q($,U.prototype),$.isPureReactComponent=!0;var ye=Array.isArray,I={H:null,A:null,T:null,S:null,V:null},_e=Object.prototype.hasOwnProperty;function Re(x,_,X,q,K,se){return X=se.ref,{$$typeof:s,type:x,key:_,ref:X!==void 0?X:null,props:se}}function Ue(x,_){return Re(x.type,_,void 0,void 0,void 0,x.props)}function we(x){return typeof x=="object"&&x!==null&&x.$$typeof===s}function et(x){var _={"=":"=0",":":"=2"};return"$"+x.replace(/[=:]/g,function(X){return _[X]})}var dt=/\/+/g;function Xe(x,_){return typeof x=="object"&&x!==null&&x.key!=null?et(""+x.key):_.toString(36)}function Na(){}function wa(x){switch(x.status){case"fulfilled":return x.value;case"rejected":throw x.reason;default:switch(typeof x.status=="string"?x.then(Na,Na):(x.status="pending",x.then(function(_){x.status==="pending"&&(x.status="fulfilled",x.value=_)},function(_){x.status==="pending"&&(x.status="rejected",x.reason=_)})),x.status){case"fulfilled":return x.value;case"rejected":throw x.reason}}throw x}function Qe(x,_,X,q,K){var se=typeof x;(se==="undefined"||se==="boolean")&&(x=null);var ee=!1;if(x===null)ee=!0;else switch(se){case"bigint":case"string":case"number":ee=!0;break;case"object":switch(x.$$typeof){case s:case f:ee=!0;break;case w:return ee=x._init,Qe(ee(x._payload),_,X,q,K)}}if(ee)return K=K(x),ee=q===""?"."+Xe(x,0):q,ye(K)?(X="",ee!=null&&(X=ee.replace(dt,"$&/")+"/"),Qe(K,_,X,"",function($t){return $t})):K!=null&&(we(K)&&(K=Ue(K,X+(K.key==null||x&&x.key===K.key?"":(""+K.key).replace(dt,"$&/")+"/")+ee)),_.push(K)),1;ee=0;var tt=q===""?".":q+":";if(ye(x))for(var ve=0;ve<x.length;ve++)q=x[ve],se=tt+Xe(q,ve),ee+=Qe(q,_,X,se,K);else if(ve=k(x),typeof ve=="function")for(x=ve.call(x),ve=0;!(q=x.next()).done;)q=q.value,se=tt+Xe(q,ve++),ee+=Qe(q,_,X,se,K);else if(se==="object"){if(typeof x.then=="function")return Qe(wa(x),_,X,q,K);throw _=String(x),Error("Objects are not valid as a React child (found: "+(_==="[object Object]"?"object with keys {"+Object.keys(x).join(", ")+"}":_)+"). If you meant to render a collection of children, use an array instead.")}return ee}function R(x,_,X){if(x==null)return x;var q=[],K=0;return Qe(x,q,"","",function(se){return _.call(X,se,K++)}),q}function Y(x){if(x._status===-1){var _=x._result;_=_(),_.then(function(X){(x._status===0||x._status===-1)&&(x._status=1,x._result=X)},function(X){(x._status===0||x._status===-1)&&(x._status=2,x._result=X)}),x._status===-1&&(x._status=0,x._result=_)}if(x._status===1)return x._result.default;throw x._result}var W=typeof reportError=="function"?reportError:function(x){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var _=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof x=="object"&&x!==null&&typeof x.message=="string"?String(x.message):String(x),error:x});if(!window.dispatchEvent(_))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",x);return}console.error(x)};function pe(){}return te.Children={map:R,forEach:function(x,_,X){R(x,function(){_.apply(this,arguments)},X)},count:function(x){var _=0;return R(x,function(){_++}),_},toArray:function(x){return R(x,function(_){return _})||[]},only:function(x){if(!we(x))throw Error("React.Children.only expected to receive a single React element child.");return x}},te.Component=U,te.Fragment=d,te.Profiler=m,te.PureComponent=G,te.StrictMode=o,te.Suspense=b,te.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=I,te.__COMPILER_RUNTIME={__proto__:null,c:function(x){return I.H.useMemoCache(x)}},te.cache=function(x){return function(){return x.apply(null,arguments)}},te.cloneElement=function(x,_,X){if(x==null)throw Error("The argument must be a React element, but you passed "+x+".");var q=Q({},x.props),K=x.key,se=void 0;if(_!=null)for(ee in _.ref!==void 0&&(se=void 0),_.key!==void 0&&(K=""+_.key),_)!_e.call(_,ee)||ee==="key"||ee==="__self"||ee==="__source"||ee==="ref"&&_.ref===void 0||(q[ee]=_[ee]);var ee=arguments.length-2;if(ee===1)q.children=X;else if(1<ee){for(var tt=Array(ee),ve=0;ve<ee;ve++)tt[ve]=arguments[ve+2];q.children=tt}return Re(x.type,K,void 0,void 0,se,q)},te.createContext=function(x){return x={$$typeof:S,_currentValue:x,_currentValue2:x,_threadCount:0,Provider:null,Consumer:null},x.Provider=x,x.Consumer={$$typeof:v,_context:x},x},te.createElement=function(x,_,X){var q,K={},se=null;if(_!=null)for(q in _.key!==void 0&&(se=""+_.key),_)_e.call(_,q)&&q!=="key"&&q!=="__self"&&q!=="__source"&&(K[q]=_[q]);var ee=arguments.length-2;if(ee===1)K.children=X;else if(1<ee){for(var tt=Array(ee),ve=0;ve<ee;ve++)tt[ve]=arguments[ve+2];K.children=tt}if(x&&x.defaultProps)for(q in ee=x.defaultProps,ee)K[q]===void 0&&(K[q]=ee[q]);return Re(x,se,void 0,void 0,null,K)},te.createRef=function(){return{current:null}},te.forwardRef=function(x){return{$$typeof:T,render:x}},te.isValidElement=we,te.lazy=function(x){return{$$typeof:w,_payload:{_status:-1,_result:x},_init:Y}},te.memo=function(x,_){return{$$typeof:p,type:x,compare:_===void 0?null:_}},te.startTransition=function(x){var _=I.T,X={};I.T=X;try{var q=x(),K=I.S;K!==null&&K(X,q),typeof q=="object"&&q!==null&&typeof q.then=="function"&&q.then(pe,W)}catch(se){W(se)}finally{I.T=_}},te.unstable_useCacheRefresh=function(){return I.H.useCacheRefresh()},te.use=function(x){return I.H.use(x)},te.useActionState=function(x,_,X){return I.H.useActionState(x,_,X)},te.useCallback=function(x,_){return I.H.useCallback(x,_)},te.useContext=function(x){return I.H.useContext(x)},te.useDebugValue=function(){},te.useDeferredValue=function(x,_){return I.H.useDeferredValue(x,_)},te.useEffect=function(x,_,X){var q=I.H;if(typeof X=="function")throw Error("useEffect CRUD overload is not enabled in this build of React.");return q.useEffect(x,_)},te.useId=function(){return I.H.useId()},te.useImperativeHandle=function(x,_,X){return I.H.useImperativeHandle(x,_,X)},te.useInsertionEffect=function(x,_){return I.H.useInsertionEffect(x,_)},te.useLayoutEffect=function(x,_){return I.H.useLayoutEffect(x,_)},te.useMemo=function(x,_){return I.H.useMemo(x,_)},te.useOptimistic=function(x,_){return I.H.useOptimistic(x,_)},te.useReducer=function(x,_,X){return I.H.useReducer(x,_,X)},te.useRef=function(x){return I.H.useRef(x)},te.useState=function(x){return I.H.useState(x)},te.useSyncExternalStore=function(x,_,X){return I.H.useSyncExternalStore(x,_,X)},te.useTransition=function(){return I.H.useTransition()},te.version="19.1.1",te}var Uf;function Mc(){return Uf||(Uf=1,wc.exports=J0()),wc.exports}var A=Mc();const Qa=V0(A);var Sc={exports:{}},On={},Ec={exports:{}},zc={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Bf;function F0(){return Bf||(Bf=1,(function(s){function f(R,Y){var W=R.length;R.push(Y);e:for(;0<W;){var pe=W-1>>>1,x=R[pe];if(0<m(x,Y))R[pe]=Y,R[W]=x,W=pe;else break e}}function d(R){return R.length===0?null:R[0]}function o(R){if(R.length===0)return null;var Y=R[0],W=R.pop();if(W!==Y){R[0]=W;e:for(var pe=0,x=R.length,_=x>>>1;pe<_;){var X=2*(pe+1)-1,q=R[X],K=X+1,se=R[K];if(0>m(q,W))K<x&&0>m(se,q)?(R[pe]=se,R[K]=W,pe=K):(R[pe]=q,R[X]=W,pe=X);else if(K<x&&0>m(se,W))R[pe]=se,R[K]=W,pe=K;else break e}}return Y}function m(R,Y){var W=R.sortIndex-Y.sortIndex;return W!==0?W:R.id-Y.id}if(s.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var v=performance;s.unstable_now=function(){return v.now()}}else{var S=Date,T=S.now();s.unstable_now=function(){return S.now()-T}}var b=[],p=[],w=1,B=null,k=3,M=!1,Q=!1,H=!1,U=!1,L=typeof setTimeout=="function"?setTimeout:null,G=typeof clearTimeout=="function"?clearTimeout:null,$=typeof setImmediate<"u"?setImmediate:null;function ye(R){for(var Y=d(p);Y!==null;){if(Y.callback===null)o(p);else if(Y.startTime<=R)o(p),Y.sortIndex=Y.expirationTime,f(b,Y);else break;Y=d(p)}}function I(R){if(H=!1,ye(R),!Q)if(d(b)!==null)Q=!0,_e||(_e=!0,Xe());else{var Y=d(p);Y!==null&&Qe(I,Y.startTime-R)}}var _e=!1,Re=-1,Ue=5,we=-1;function et(){return U?!0:!(s.unstable_now()-we<Ue)}function dt(){if(U=!1,_e){var R=s.unstable_now();we=R;var Y=!0;try{e:{Q=!1,H&&(H=!1,G(Re),Re=-1),M=!0;var W=k;try{t:{for(ye(R),B=d(b);B!==null&&!(B.expirationTime>R&&et());){var pe=B.callback;if(typeof pe=="function"){B.callback=null,k=B.priorityLevel;var x=pe(B.expirationTime<=R);if(R=s.unstable_now(),typeof x=="function"){B.callback=x,ye(R),Y=!0;break t}B===d(b)&&o(b),ye(R)}else o(b);B=d(b)}if(B!==null)Y=!0;else{var _=d(p);_!==null&&Qe(I,_.startTime-R),Y=!1}}break e}finally{B=null,k=W,M=!1}Y=void 0}}finally{Y?Xe():_e=!1}}}var Xe;if(typeof $=="function")Xe=function(){$(dt)};else if(typeof MessageChannel<"u"){var Na=new MessageChannel,wa=Na.port2;Na.port1.onmessage=dt,Xe=function(){wa.postMessage(null)}}else Xe=function(){L(dt,0)};function Qe(R,Y){Re=L(function(){R(s.unstable_now())},Y)}s.unstable_IdlePriority=5,s.unstable_ImmediatePriority=1,s.unstable_LowPriority=4,s.unstable_NormalPriority=3,s.unstable_Profiling=null,s.unstable_UserBlockingPriority=2,s.unstable_cancelCallback=function(R){R.callback=null},s.unstable_forceFrameRate=function(R){0>R||125<R?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):Ue=0<R?Math.floor(1e3/R):5},s.unstable_getCurrentPriorityLevel=function(){return k},s.unstable_next=function(R){switch(k){case 1:case 2:case 3:var Y=3;break;default:Y=k}var W=k;k=Y;try{return R()}finally{k=W}},s.unstable_requestPaint=function(){U=!0},s.unstable_runWithPriority=function(R,Y){switch(R){case 1:case 2:case 3:case 4:case 5:break;default:R=3}var W=k;k=R;try{return Y()}finally{k=W}},s.unstable_scheduleCallback=function(R,Y,W){var pe=s.unstable_now();switch(typeof W=="object"&&W!==null?(W=W.delay,W=typeof W=="number"&&0<W?pe+W:pe):W=pe,R){case 1:var x=-1;break;case 2:x=250;break;case 5:x=1073741823;break;case 4:x=1e4;break;default:x=5e3}return x=W+x,R={id:w++,callback:Y,priorityLevel:R,startTime:W,expirationTime:x,sortIndex:-1},W>pe?(R.sortIndex=W,f(p,R),d(b)===null&&R===d(p)&&(H?(G(Re),Re=-1):H=!0,Qe(I,W-pe))):(R.sortIndex=x,f(b,R),Q||M||(Q=!0,_e||(_e=!0,Xe()))),R},s.unstable_shouldYield=et,s.unstable_wrapCallback=function(R){var Y=k;return function(){var W=k;k=Y;try{return R.apply(this,arguments)}finally{k=W}}}})(zc)),zc}var Hf;function W0(){return Hf||(Hf=1,Ec.exports=F0()),Ec.exports}var Tc={exports:{}},Ke={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var kf;function $0(){if(kf)return Ke;kf=1;var s=Mc();function f(b){var p="https://react.dev/errors/"+b;if(1<arguments.length){p+="?args[]="+encodeURIComponent(arguments[1]);for(var w=2;w<arguments.length;w++)p+="&args[]="+encodeURIComponent(arguments[w])}return"Minified React error #"+b+"; visit "+p+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}function d(){}var o={d:{f:d,r:function(){throw Error(f(522))},D:d,C:d,L:d,m:d,X:d,S:d,M:d},p:0,findDOMNode:null},m=Symbol.for("react.portal");function v(b,p,w){var B=3<arguments.length&&arguments[3]!==void 0?arguments[3]:null;return{$$typeof:m,key:B==null?null:""+B,children:b,containerInfo:p,implementation:w}}var S=s.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE;function T(b,p){if(b==="font")return"";if(typeof p=="string")return p==="use-credentials"?p:""}return Ke.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=o,Ke.createPortal=function(b,p){var w=2<arguments.length&&arguments[2]!==void 0?arguments[2]:null;if(!p||p.nodeType!==1&&p.nodeType!==9&&p.nodeType!==11)throw Error(f(299));return v(b,p,null,w)},Ke.flushSync=function(b){var p=S.T,w=o.p;try{if(S.T=null,o.p=2,b)return b()}finally{S.T=p,o.p=w,o.d.f()}},Ke.preconnect=function(b,p){typeof b=="string"&&(p?(p=p.crossOrigin,p=typeof p=="string"?p==="use-credentials"?p:"":void 0):p=null,o.d.C(b,p))},Ke.prefetchDNS=function(b){typeof b=="string"&&o.d.D(b)},Ke.preinit=function(b,p){if(typeof b=="string"&&p&&typeof p.as=="string"){var w=p.as,B=T(w,p.crossOrigin),k=typeof p.integrity=="string"?p.integrity:void 0,M=typeof p.fetchPriority=="string"?p.fetchPriority:void 0;w==="style"?o.d.S(b,typeof p.precedence=="string"?p.precedence:void 0,{crossOrigin:B,integrity:k,fetchPriority:M}):w==="script"&&o.d.X(b,{crossOrigin:B,integrity:k,fetchPriority:M,nonce:typeof p.nonce=="string"?p.nonce:void 0})}},Ke.preinitModule=function(b,p){if(typeof b=="string")if(typeof p=="object"&&p!==null){if(p.as==null||p.as==="script"){var w=T(p.as,p.crossOrigin);o.d.M(b,{crossOrigin:w,integrity:typeof p.integrity=="string"?p.integrity:void 0,nonce:typeof p.nonce=="string"?p.nonce:void 0})}}else p==null&&o.d.M(b)},Ke.preload=function(b,p){if(typeof b=="string"&&typeof p=="object"&&p!==null&&typeof p.as=="string"){var w=p.as,B=T(w,p.crossOrigin);o.d.L(b,w,{crossOrigin:B,integrity:typeof p.integrity=="string"?p.integrity:void 0,nonce:typeof p.nonce=="string"?p.nonce:void 0,type:typeof p.type=="string"?p.type:void 0,fetchPriority:typeof p.fetchPriority=="string"?p.fetchPriority:void 0,referrerPolicy:typeof p.referrerPolicy=="string"?p.referrerPolicy:void 0,imageSrcSet:typeof p.imageSrcSet=="string"?p.imageSrcSet:void 0,imageSizes:typeof p.imageSizes=="string"?p.imageSizes:void 0,media:typeof p.media=="string"?p.media:void 0})}},Ke.preloadModule=function(b,p){if(typeof b=="string")if(p){var w=T(p.as,p.crossOrigin);o.d.m(b,{as:typeof p.as=="string"&&p.as!=="script"?p.as:void 0,crossOrigin:w,integrity:typeof p.integrity=="string"?p.integrity:void 0})}else o.d.m(b)},Ke.requestFormReset=function(b){o.d.r(b)},Ke.unstable_batchedUpdates=function(b,p){return b(p)},Ke.useFormState=function(b,p,w){return S.H.useFormState(b,p,w)},Ke.useFormStatus=function(){return S.H.useHostTransitionStatus()},Ke.version="19.1.1",Ke}var Lf;function P0(){if(Lf)return Tc.exports;Lf=1;function s(){if(!(typeof __REACT_DEVTOOLS_GLOBAL_HOOK__>"u"||typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE!="function"))try{__REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE(s)}catch(f){console.error(f)}}return s(),Tc.exports=$0(),Tc.exports}/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var qf;function I0(){if(qf)return On;qf=1;var s=W0(),f=Mc(),d=P0();function o(e){var t="https://react.dev/errors/"+e;if(1<arguments.length){t+="?args[]="+encodeURIComponent(arguments[1]);for(var a=2;a<arguments.length;a++)t+="&args[]="+encodeURIComponent(arguments[a])}return"Minified React error #"+e+"; visit "+t+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}function m(e){return!(!e||e.nodeType!==1&&e.nodeType!==9&&e.nodeType!==11)}function v(e){var t=e,a=e;if(e.alternate)for(;t.return;)t=t.return;else{e=t;do t=e,(t.flags&4098)!==0&&(a=t.return),e=t.return;while(e)}return t.tag===3?a:null}function S(e){if(e.tag===13){var t=e.memoizedState;if(t===null&&(e=e.alternate,e!==null&&(t=e.memoizedState)),t!==null)return t.dehydrated}return null}function T(e){if(v(e)!==e)throw Error(o(188))}function b(e){var t=e.alternate;if(!t){if(t=v(e),t===null)throw Error(o(188));return t!==e?null:e}for(var a=e,l=t;;){var n=a.return;if(n===null)break;var r=n.alternate;if(r===null){if(l=n.return,l!==null){a=l;continue}break}if(n.child===r.child){for(r=n.child;r;){if(r===a)return T(n),e;if(r===l)return T(n),t;r=r.sibling}throw Error(o(188))}if(a.return!==l.return)a=n,l=r;else{for(var c=!1,u=n.child;u;){if(u===a){c=!0,a=n,l=r;break}if(u===l){c=!0,l=n,a=r;break}u=u.sibling}if(!c){for(u=r.child;u;){if(u===a){c=!0,a=r,l=n;break}if(u===l){c=!0,l=r,a=n;break}u=u.sibling}if(!c)throw Error(o(189))}}if(a.alternate!==l)throw Error(o(190))}if(a.tag!==3)throw Error(o(188));return a.stateNode.current===a?e:t}function p(e){var t=e.tag;if(t===5||t===26||t===27||t===6)return e;for(e=e.child;e!==null;){if(t=p(e),t!==null)return t;e=e.sibling}return null}var w=Object.assign,B=Symbol.for("react.element"),k=Symbol.for("react.transitional.element"),M=Symbol.for("react.portal"),Q=Symbol.for("react.fragment"),H=Symbol.for("react.strict_mode"),U=Symbol.for("react.profiler"),L=Symbol.for("react.provider"),G=Symbol.for("react.consumer"),$=Symbol.for("react.context"),ye=Symbol.for("react.forward_ref"),I=Symbol.for("react.suspense"),_e=Symbol.for("react.suspense_list"),Re=Symbol.for("react.memo"),Ue=Symbol.for("react.lazy"),we=Symbol.for("react.activity"),et=Symbol.for("react.memo_cache_sentinel"),dt=Symbol.iterator;function Xe(e){return e===null||typeof e!="object"?null:(e=dt&&e[dt]||e["@@iterator"],typeof e=="function"?e:null)}var Na=Symbol.for("react.client.reference");function wa(e){if(e==null)return null;if(typeof e=="function")return e.$$typeof===Na?null:e.displayName||e.name||null;if(typeof e=="string")return e;switch(e){case Q:return"Fragment";case U:return"Profiler";case H:return"StrictMode";case I:return"Suspense";case _e:return"SuspenseList";case we:return"Activity"}if(typeof e=="object")switch(e.$$typeof){case M:return"Portal";case $:return(e.displayName||"Context")+".Provider";case G:return(e._context.displayName||"Context")+".Consumer";case ye:var t=e.render;return e=e.displayName,e||(e=t.displayName||t.name||"",e=e!==""?"ForwardRef("+e+")":"ForwardRef"),e;case Re:return t=e.displayName||null,t!==null?t:wa(e.type)||"Memo";case Ue:t=e._payload,e=e._init;try{return wa(e(t))}catch{}}return null}var Qe=Array.isArray,R=f.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE,Y=d.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE,W={pending:!1,data:null,method:null,action:null},pe=[],x=-1;function _(e){return{current:e}}function X(e){0>x||(e.current=pe[x],pe[x]=null,x--)}function q(e,t){x++,pe[x]=e.current,e.current=t}var K=_(null),se=_(null),ee=_(null),tt=_(null);function ve(e,t){switch(q(ee,t),q(se,e),q(K,null),t.nodeType){case 9:case 11:e=(e=t.documentElement)&&(e=e.namespaceURI)?rf(e):0;break;default:if(e=t.tagName,t=t.namespaceURI)t=rf(t),e=sf(t,e);else switch(e){case"svg":e=1;break;case"math":e=2;break;default:e=0}}X(K),q(K,e)}function $t(){X(K),X(se),X(ee)}function sr(e){e.memoizedState!==null&&q(tt,e);var t=K.current,a=sf(t,e.type);t!==a&&(q(se,e),q(K,a))}function kn(e){se.current===e&&(X(K),X(se)),tt.current===e&&(X(tt),En._currentValue=W)}var cr=Object.prototype.hasOwnProperty,or=s.unstable_scheduleCallback,ur=s.unstable_cancelCallback,wm=s.unstable_shouldYield,Sm=s.unstable_requestPaint,St=s.unstable_now,Em=s.unstable_getCurrentPriorityLevel,kc=s.unstable_ImmediatePriority,Lc=s.unstable_UserBlockingPriority,Ln=s.unstable_NormalPriority,zm=s.unstable_LowPriority,qc=s.unstable_IdlePriority,Tm=s.log,Am=s.unstable_setDisableYieldValue,Ml=null,at=null;function Pt(e){if(typeof Tm=="function"&&Am(e),at&&typeof at.setStrictMode=="function")try{at.setStrictMode(Ml,e)}catch{}}var lt=Math.clz32?Math.clz32:Om,Dm=Math.log,Rm=Math.LN2;function Om(e){return e>>>=0,e===0?32:31-(Dm(e)/Rm|0)|0}var qn=256,Yn=4194304;function Sa(e){var t=e&42;if(t!==0)return t;switch(e&-e){case 1:return 1;case 2:return 2;case 4:return 4;case 8:return 8;case 16:return 16;case 32:return 32;case 64:return 64;case 128:return 128;case 256:case 512:case 1024:case 2048:case 4096:case 8192:case 16384:case 32768:case 65536:case 131072:case 262144:case 524288:case 1048576:case 2097152:return e&4194048;case 4194304:case 8388608:case 16777216:case 33554432:return e&62914560;case 67108864:return 67108864;case 134217728:return 134217728;case 268435456:return 268435456;case 536870912:return 536870912;case 1073741824:return 0;default:return e}}function Gn(e,t,a){var l=e.pendingLanes;if(l===0)return 0;var n=0,r=e.suspendedLanes,c=e.pingedLanes;e=e.warmLanes;var u=l&134217727;return u!==0?(l=u&~r,l!==0?n=Sa(l):(c&=u,c!==0?n=Sa(c):a||(a=u&~e,a!==0&&(n=Sa(a))))):(u=l&~r,u!==0?n=Sa(u):c!==0?n=Sa(c):a||(a=l&~e,a!==0&&(n=Sa(a)))),n===0?0:t!==0&&t!==n&&(t&r)===0&&(r=n&-n,a=t&-t,r>=a||r===32&&(a&4194048)!==0)?t:n}function Cl(e,t){return(e.pendingLanes&~(e.suspendedLanes&~e.pingedLanes)&t)===0}function Mm(e,t){switch(e){case 1:case 2:case 4:case 8:case 64:return t+250;case 16:case 32:case 128:case 256:case 512:case 1024:case 2048:case 4096:case 8192:case 16384:case 32768:case 65536:case 131072:case 262144:case 524288:case 1048576:case 2097152:return t+5e3;case 4194304:case 8388608:case 16777216:case 33554432:return-1;case 67108864:case 134217728:case 268435456:case 536870912:case 1073741824:return-1;default:return-1}}function Yc(){var e=qn;return qn<<=1,(qn&4194048)===0&&(qn=256),e}function Gc(){var e=Yn;return Yn<<=1,(Yn&62914560)===0&&(Yn=4194304),e}function dr(e){for(var t=[],a=0;31>a;a++)t.push(e);return t}function _l(e,t){e.pendingLanes|=t,t!==268435456&&(e.suspendedLanes=0,e.pingedLanes=0,e.warmLanes=0)}function Cm(e,t,a,l,n,r){var c=e.pendingLanes;e.pendingLanes=a,e.suspendedLanes=0,e.pingedLanes=0,e.warmLanes=0,e.expiredLanes&=a,e.entangledLanes&=a,e.errorRecoveryDisabledLanes&=a,e.shellSuspendCounter=0;var u=e.entanglements,h=e.expirationTimes,N=e.hiddenUpdates;for(a=c&~a;0<a;){var D=31-lt(a),C=1<<D;u[D]=0,h[D]=-1;var E=N[D];if(E!==null)for(N[D]=null,D=0;D<E.length;D++){var z=E[D];z!==null&&(z.lane&=-536870913)}a&=~C}l!==0&&Xc(e,l,0),r!==0&&n===0&&e.tag!==0&&(e.suspendedLanes|=r&~(c&~t))}function Xc(e,t,a){e.pendingLanes|=t,e.suspendedLanes&=~t;var l=31-lt(t);e.entangledLanes|=t,e.entanglements[l]=e.entanglements[l]|1073741824|a&4194090}function Qc(e,t){var a=e.entangledLanes|=t;for(e=e.entanglements;a;){var l=31-lt(a),n=1<<l;n&t|e[l]&t&&(e[l]|=t),a&=~n}}function fr(e){switch(e){case 2:e=1;break;case 8:e=4;break;case 32:e=16;break;case 256:case 512:case 1024:case 2048:case 4096:case 8192:case 16384:case 32768:case 65536:case 131072:case 262144:case 524288:case 1048576:case 2097152:case 4194304:case 8388608:case 16777216:case 33554432:e=128;break;case 268435456:e=134217728;break;default:e=0}return e}function mr(e){return e&=-e,2<e?8<e?(e&134217727)!==0?32:268435456:8:2}function Vc(){var e=Y.p;return e!==0?e:(e=window.event,e===void 0?32:zf(e.type))}function _m(e,t){var a=Y.p;try{return Y.p=e,t()}finally{Y.p=a}}var It=Math.random().toString(36).slice(2),Ve="__reactFiber$"+It,Fe="__reactProps$"+It,Va="__reactContainer$"+It,hr="__reactEvents$"+It,Um="__reactListeners$"+It,Bm="__reactHandles$"+It,Zc="__reactResources$"+It,Ul="__reactMarker$"+It;function pr(e){delete e[Ve],delete e[Fe],delete e[hr],delete e[Um],delete e[Bm]}function Za(e){var t=e[Ve];if(t)return t;for(var a=e.parentNode;a;){if(t=a[Va]||a[Ve]){if(a=t.alternate,t.child!==null||a!==null&&a.child!==null)for(e=df(e);e!==null;){if(a=e[Ve])return a;e=df(e)}return t}e=a,a=e.parentNode}return null}function Ka(e){if(e=e[Ve]||e[Va]){var t=e.tag;if(t===5||t===6||t===13||t===26||t===27||t===3)return e}return null}function Bl(e){var t=e.tag;if(t===5||t===26||t===27||t===6)return e.stateNode;throw Error(o(33))}function Ja(e){var t=e[Zc];return t||(t=e[Zc]={hoistableStyles:new Map,hoistableScripts:new Map}),t}function Be(e){e[Ul]=!0}var Kc=new Set,Jc={};function Ea(e,t){Fa(e,t),Fa(e+"Capture",t)}function Fa(e,t){for(Jc[e]=t,e=0;e<t.length;e++)Kc.add(t[e])}var Hm=RegExp("^[:A-Z_a-z\\u00C0-\\u00D6\\u00D8-\\u00F6\\u00F8-\\u02FF\\u0370-\\u037D\\u037F-\\u1FFF\\u200C-\\u200D\\u2070-\\u218F\\u2C00-\\u2FEF\\u3001-\\uD7FF\\uF900-\\uFDCF\\uFDF0-\\uFFFD][:A-Z_a-z\\u00C0-\\u00D6\\u00D8-\\u00F6\\u00F8-\\u02FF\\u0370-\\u037D\\u037F-\\u1FFF\\u200C-\\u200D\\u2070-\\u218F\\u2C00-\\u2FEF\\u3001-\\uD7FF\\uF900-\\uFDCF\\uFDF0-\\uFFFD\\-.0-9\\u00B7\\u0300-\\u036F\\u203F-\\u2040]*$"),Fc={},Wc={};function km(e){return cr.call(Wc,e)?!0:cr.call(Fc,e)?!1:Hm.test(e)?Wc[e]=!0:(Fc[e]=!0,!1)}function Xn(e,t,a){if(km(t))if(a===null)e.removeAttribute(t);else{switch(typeof a){case"undefined":case"function":case"symbol":e.removeAttribute(t);return;case"boolean":var l=t.toLowerCase().slice(0,5);if(l!=="data-"&&l!=="aria-"){e.removeAttribute(t);return}}e.setAttribute(t,""+a)}}function Qn(e,t,a){if(a===null)e.removeAttribute(t);else{switch(typeof a){case"undefined":case"function":case"symbol":case"boolean":e.removeAttribute(t);return}e.setAttribute(t,""+a)}}function Mt(e,t,a,l){if(l===null)e.removeAttribute(a);else{switch(typeof l){case"undefined":case"function":case"symbol":case"boolean":e.removeAttribute(a);return}e.setAttributeNS(t,a,""+l)}}var xr,$c;function Wa(e){if(xr===void 0)try{throw Error()}catch(a){var t=a.stack.trim().match(/\n( *(at )?)/);xr=t&&t[1]||"",$c=-1<a.stack.indexOf(`
 ...
 *
 * @license MIT
 */var Gf="popstate";function ap(s={}){function f(o,m){let{pathname:v,search:S,hash:T}=o.location;return Rc("",{pathname:v,search:S,hash:T},m.state&&m.state.usr||null,m.state&&m.state.key||"default")}function d(o,m){return typeof m=="string"?m:_n(m)}return np(f,d,null,s)}function Ne(s,f){if(s===!1||s===null||typeof s>"u")throw new Error(f)}function Rt(s,f){if(!s){typeof console<"u"&&console.warn(f);try{throw new Error(f)}catch{}}}function lp(){return Math.random().toString(36).substring(2,10)}function Xf(s,f){return{usr:s.state,key:s.key,idx:f}}function Rc(s,f,d=null,o){return{pathname:typeof s=="string"?s:s.pathname,search:"",hash:"",...typeof f=="string"?Rl(f):f,state:d,key:f&&f.key||o||lp()}}function _n({pathname:s="/",search:f="",hash:d=""}){return f&&f!=="?"&&(s+=f.charAt(0)==="?"?f:"?"+f),d&&d!=="#"&&(s+=d.charAt(0)==="#"?d:"#"+d),s}function Rl(s){let f={};if(s){let d=s.indexOf("#");d>=0&&(f.hash=s.substring(d),s=s.substring(0,d));let o=s.indexOf("?");o>=0&&(f.search=s.substring(o),s=s.substring(0,o)),s&&(f.pathname=s)}return f}function np(s,f,d,o={}){let{window:m=document.defaultView,v5Compat:v=!1}=o,S=m.history,T="POP",b=null,p=w();p==null&&(p=0,S.replaceState({...S.state,idx:p},""));function w(){return(S.state||{idx:null}).idx}function B(){T="POP";let U=w(),L=U==null?null:U-p;p=U,b&&b({action:T,location:H.location,delta:L})}function k(U,L){T="PUSH";let G=Rc(H.location,U,L);p=w()+1;let $=Xf(G,p),ye=H.createHref(G);try{S.pushState($,"",ye)}catch(I){if(I instanceof DOMException&&I.name==="DataCloneError")throw I;m.location.assign(ye)}v&&b&&b({action:T,location:H.location,delta:1})}function M(U,L){T="REPLACE";let G=Rc(H.location,U,L);p=w();let $=Xf(G,p),ye=H.createHref(G);S.replaceState($,"",ye),v&&b&&b({action:T,location:H.location,delta:0})}function Q(U){return ip(U)}let H={get action(){return T},get location(){return s(m,S)},listen(U){if(b)throw new Error("A history only accepts one active listener");return m.addEventListener(Gf,B),b=U,()=>{m.removeEventListener(Gf,B),b=null}},createHref(U){return f(m,U)},createURL:Q,encodeLocation(U){let L=Q(U);return{pathname:L.pathname,search:L.search,hash:L.hash}},push:k,replace:M,go(U){return S.go(U)}};return H}function ip(s,f=!1){let d="http://localhost";typeof window<"u"&&(d=window.location.origin!=="null"?window.location.origin:window.location.href),Ne(d,"No window.location.(origin|href) available to create URL");let o=typeof s=="string"?s:_n(s);return o=o.replace(/ $/,"%20"),!f&&o.startsWith("//")&&(o=d+o),new URL(o,d)}function em(s,f,d="/"){return rp(s,f,d,!1)}function rp(s,f,d,o){let m=typeof f=="string"?Rl(f):f,v=Jt(m.pathname||"/",d);if(v==null)return null;let S=tm(s);sp(S);let T=null;for(let b=0;T==null&&b<S.length;++b){let p=vp(v);T=xp(S[b],p,o)}return T}function tm(s,f=[],d=[],o="",m=!1){let v=(S,T,b=m,p)=>{let w={relativePath:p===void 0?S.path||"":p,caseSensitive:S.caseSensitive===!0,childrenIndex:T,route:S};if(w.relativePath.startsWith("/")){if(!w.relativePath.startsWith(o)&&b)return;Ne(w.relativePath.startsWith(o),`Absolute route path "${w.relativePath}" nested under path "${o}" is not valid. An absolute child route path must start with the combined path of all its parent routes.`),w.relativePath=w.relativePath.slice(o.length)}let B=Kt([o,w.relativePath]),k=d.concat(w);S.children&&S.children.length>0&&(Ne(S.index!==!0,`Index routes must not have child routes. Please remove all child routes from route path "${B}".`),tm(S.children,f,k,B,b)),!(S.path==null&&!S.index)&&f.push({path:B,score:hp(B,S.index),routesMeta:k})};return s.forEach((S,T)=>{if(S.path===""||!S.path?.includes("?"))v(S,T);else for(let b of am(S.path))v(S,T,!0,b)}),f}function am(s){let f=s.split("/");if(f.length===0)return[];let[d,...o]=f,m=d.endsWith("?"),v=d.replace(/\?$/,"");if(o.length===0)return m?[v,""]:[v];let S=am(o.join("/")),T=[];return T.push(...S.map(b=>b===""?v:[v,b].join("/"))),m&&T.push(...S),T.map(b=>s.startsWith("/")&&b===""?"/":b)}function sp(s){s.sort((f,d)=>f.score!==d.score?d.score-f.score:pp(f.routesMeta.map(o=>o.childrenIndex),d.routesMeta.map(o=>o.childrenIndex)))}var cp=/^:[\w-]+$/,op=3,up=2,dp=1,fp=10,mp=-2,Qf=s=>s==="*";function hp(s,f){let d=s.split("/"),o=d.length;return d.some(Qf)&&(o+=mp),f&&(o+=up),d.filter(m=>!Qf(m)).reduce((m,v)=>m+(cp.test(v)?op:v===""?dp:fp),o)}function pp(s,f){return s.length===f.length&&s.slice(0,-1).every((o,m)=>o===f[m])?s[s.length-1]-f[f.length-1]:0}function xp(s,f,d=!1){let{routesMeta:o}=s,m={},v="/",S=[];for(let T=0;T<o.length;++T){let b=o[T],p=T===o.length-1,w=v==="/"?f:f.slice(v.length)||"/",B=ar({path:b.relativePath,caseSensitive:b.caseSensitive,end:p},w),k=b.route;if(!B&&p&&d&&!o[o.length-1].route.index&&(B=ar({path:b.relativePath,caseSensitive:b.caseSensitive,end:!1},w)),!B)return null;Object.assign(m,B.params),S.push({params:m,pathname:Kt([v,B.pathname]),pathnameBase:Np(Kt([v,B.pathnameBase])),route:k}),B.pathnameBase!=="/"&&(v=Kt([v,B.pathnameBase]))}return S}function ar(s,f){typeof s=="string"&&(s={path:s,caseSensitive:!1,end:!0});let[d,o]=gp(s.path,s.caseSensitive,s.end),m=f.match(d);if(!m)return null;let v=m[0],S=v.replace(/(.)\/+$/,"$1"),T=m.slice(1);return{params:o.reduce((p,{paramName:w,isOptional:B},k)=>{if(w==="*"){let Q=T[k]||"";S=v.slice(0,v.length-Q.length).replace(/(.)\/+$/,"$1")}const M=T[k];return B&&!M?p[w]=void 0:p[w]=(M||"").replace(/%2F/g,"/"),p},{}),pathname:v,pathnameBase:S,pattern:s}}function gp(s,f=!1,d=!0){Rt(s==="*"||!s.endsWith("*")||s.endsWith("/*"),`Route path "${s}" will be treated as if it were "${s.replace(/\*$/,"/*")}" because the \`*\` character must always follow a \`/\` in the pattern. To get rid of this warning, please change the route path to "${s.replace(/\*$/,"/*")}".`);let o=[],m="^"+s.replace(/\/*\*?$/,"").replace(/^\/*/,"/").replace(/[\\.*+^${}|()[\]]/g,"\\$&").replace(/\/:([\w-]+)(\?)?/g,(S,T,b)=>(o.push({paramName:T,isOptional:b!=null}),b?"/?([^\\/]+)?":"/([^\\/]+)")).replace(/\/([\w-]+)\?(\/|$)/g,"(/$1)?$2");return s.endsWith("*")?(o.push({paramName:"*"}),m+=s==="*"||s==="/*"?"(.*)$":"(?:\\/(.+)|\\/*)$"):d?m+="\\/*$":s!==""&&s!=="/"&&(m+="(?:(?=\\/|$))"),[new RegExp(m,f?void 0:"i"),o]}function vp(s){try{return s.split("/").map(f=>decodeURIComponent(f).replace(/\//g,"%2F")).join("/")}catch(f){return Rt(!1,`The URL path "${s}" could not be decoded because it is a malformed URL segment. This is probably due to a bad percent encoding (${f}).`),s}}function Jt(s,f){if(f==="/")return s;if(!s.toLowerCase().startsWith(f.toLowerCase()))return null;let d=f.endsWith("/")?f.length-1:f.length,o=s.charAt(d);return o&&o!=="/"?null:s.slice(d)||"/"}function bp(s,f="/"){let{pathname:d,search:o="",hash:m=""}=typeof s=="string"?Rl(s):s;return{pathname:d?d.startsWith("/")?d:yp(d,f):f,search:wp(o),hash:Sp(m)}}function yp(s,f){let d=f.replace(/\/+$/,"").split("/");return s.split("/").forEach(m=>{m===".."?d.length>1&&d.pop():m!=="."&&d.push(m)}),d.length>1?d.join("/"):"/"}function Ac(s,f,d,o){return`Cannot include a '${s}' character in a manually specified \`to.${f}\` field [${JSON.stringify(o)}].  Please separate it out to the \`to.${d}\` field. Alternatively you may provide the full path as a string in <Link to="..."> and the router will parse it for you.`}function jp(s){return s.filter((f,d)=>d===0||f.route.path&&f.route.path.length>0)}function lm(s){let f=jp(s);return f.map((d,o)=>o===f.length-1?d.pathname:d.pathnameBase)}function nm(s,f,d,o=!1){let m;typeof s=="string"?m=Rl(s):(m={...s},Ne(!m.pathname||!m.pathname.includes("?"),Ac("?","pathname","search",m)),Ne(!m.pathname||!m.pathname.includes("#"),Ac("#","pathname","hash",m)),Ne(!m.search||!m.search.includes("#"),Ac("#","search","hash",m)));let v=s===""||m.pathname==="",S=v?"/":m.pathname,T;if(S==null)T=d;else{let B=f.length-1;if(!o&&S.startsWith("..")){let k=S.split("/");for(;k[0]==="..";)k.shift(),B-=1;m.pathname=k.join("/")}T=B>=0?f[B]:"/"}let b=bp(m,T),p=S&&S!=="/"&&S.endsWith("/"),w=(v||S===".")&&d.endsWith("/");return!b.pathname.endsWith("/")&&(p||w)&&(b.pathname+="/"),b}var Kt=s=>s.join("/").replace(/\/\/+/g,"/"),Np=s=>s.replace(/\/+$/,"").replace(/^\/*/,"/"),wp=s=>!s||s==="?"?"":s.startsWith("?")?s:"?"+s,Sp=s=>!s||s==="#"?"":s.startsWith("#")?s:"#"+s;function Ep(s){return s!=null&&typeof s.status=="number"&&typeof s.statusText=="string"&&typeof s.internal=="boolean"&&"data"in s}var im=["POST","PUT","PATCH","DELETE"];new Set(im);var zp=["GET",...im];new Set(zp);var Ol=A.createContext(null);Ol.displayName="DataRouter";var ir=A.createContext(null);ir.displayName="DataRouterState";A.createContext(!1);var rm=A.createContext({isTransitioning:!1});rm.displayName="ViewTransition";var Tp=A.createContext(new Map);Tp.displayName="Fetchers";var Ap=A.createContext(null);Ap.displayName="Await";var Ot=A.createContext(null);Ot.displayName="Navigation";var Un=A.createContext(null);Un.displayName="Location";var Ft=A.createContext({outlet:null,matches:[],isDataRoute:!1});Ft.displayName="Route";var Cc=A.createContext(null);Cc.displayName="RouteError";function Dp(s,{relative:f}={}){Ne(Bn(),"useHref() may be used only in the context of a <Router> component.");let{basename:d,navigator:o}=A.useContext(Ot),{hash:m,pathname:v,search:S}=Hn(s,{relative:f}),T=v;return d!=="/"&&(T=v==="/"?d:Kt([d,v])),o.createHref({pathname:T,search:S,hash:m})}function Bn(){return A.useContext(Un)!=null}function Wt(){return Ne(Bn(),"useLocation() may be used only in the context of a <Router> component."),A.useContext(Un).location}var sm="You should call navigate() in a React.useEffect(), not when your component is first rendered.";function cm(s){A.useContext(Ot).static||A.useLayoutEffect(s)}function Rp(){let{isDataRoute:s}=A.useContext(Ft);return s?Xp():Op()}function Op(){Ne(Bn(),"useNavigate() may be used only in the context of a <Router> component.");let s=A.useContext(Ol),{basename:f,navigator:d}=A.useContext(Ot),{matches:o}=A.useContext(Ft),{pathname:m}=Wt(),v=JSON.stringify(lm(o)),S=A.useRef(!1);return cm(()=>{S.current=!0}),A.useCallback((b,p={})=>{if(Rt(S.current,sm),!S.current)return;if(typeof b=="number"){d.go(b);return}let w=nm(b,JSON.parse(v),m,p.relative==="path");s==null&&f!=="/"&&(w.pathname=w.pathname==="/"?f:Kt([f,w.pathname])),(p.replace?d.replace:d.push)(w,p.state,p)},[f,d,v,m,s])}A.createContext(null);function Hn(s,{relative:f}={}){let{matches:d}=A.useContext(Ft),{pathname:o}=Wt(),m=JSON.stringify(lm(d));return A.useMemo(()=>nm(s,JSON.parse(m),o,f==="path"),[s,m,o,f])}function Mp(s,f){return om(s,f)}function om(s,f,d,o,m){Ne(Bn(),"useRoutes() may be used only in the context of a <Router> component.");let{navigator:v}=A.useContext(Ot),{matches:S}=A.useContext(Ft),T=S[S.length-1],b=T?T.params:{},p=T?T.pathname:"/",w=T?T.pathnameBase:"/",B=T&&T.route;{let G=B&&B.path||"";um(p,!B||G.endsWith("*")||G.endsWith("*?"),`You rendered descendant <Routes> (or called \`useRoutes()\`) at "${p}" (under <Route path="${G}">) but the parent route path has no trailing "*". This means if you navigate deeper, the parent won't match anymore and therefore the child routes will never render.

Please change the parent <Route path="${G}"> to <Route path="${G==="/"?"*":`${G}/*`}">.`)}let k=Wt(),M;if(f){let G=typeof f=="string"?Rl(f):f;Ne(w==="/"||G.pathname?.startsWith(w),`When overriding the location using \`<Routes location>\` or \`useRoutes(routes, location)\`, the location pathname must begin with the portion of the URL pathname that was matched by all parent routes. The current pathname base is "${w}" but pathname "${G.pathname}" was given in the \`location\` prop.`),M=G}else M=k;let Q=M.pathname||"/",H=Q;if(w!=="/"){let G=w.replace(/^\//,"").split("/");H="/"+Q.replace(/^\//,"").split("/").slice(G.length).join("/")}let U=em(s,{pathname:H});Rt(B||U!=null,`No routes matched location "${M.pathname}${M.search}${M.hash}" `),Rt(U==null||U[U.length-1].route.element!==void 0||U[U.length-1].route.Component!==void 0||U[U.length-1].route.lazy!==void 0,`Matched leaf route at location "${M.pathname}${M.search}${M.hash}" does not have an element or Component. This means it will render an <Outlet /> with a null value by default resulting in an "empty" page.`);let L=Hp(U&&U.map(G=>Object.assign({},G,{params:Object.assign({},b,G.params),pathname:Kt([w,v.encodeLocation?v.encodeLocation(G.pathname).pathname:G.pathname]),pathnameBase:G.pathnameBase==="/"?w:Kt([w,v.encodeLocation?v.encodeLocation(G.pathnameBase).pathname:G.pathnameBase])})),S,d,o,m);return f&&L?A.createElement(Un.Provider,{value:{location:{pathname:"/",search:"",hash:"",state:null,key:"default",...M},navigationType:"POP"}},L):L}function Cp(){let s=Gp(),f=Ep(s)?`${s.status} ${s.statusText}`:s instanceof Error?s.message:JSON.stringify(s),d=s instanceof Error?s.stack:null,o="rgba(200,200,200, 0.5)",m={padding:"0.5rem",backgroundColor:o},v={padding:"2px 4px",backgroundColor:o},S=null;return console.error("Error handled by React Router default ErrorBoundary:",s),S=A.createElement(A.Fragment,null,A.createElement("p",null,"💿 Hey developer 👋"),A.createElement("p",null,"You can provide a way better UX than this when your app throws errors by providing your own ",A.createElement("code",{style:v},"ErrorBoundary")," or"," ",A.createElement("code",{style:v},"errorElement")," prop on your route.")),A.createElement(A.Fragment,null,A.createElement("h2",null,"Unexpected Application Error!"),A.createElement("h3",{style:{fontStyle:"italic"}},f),d?A.createElement("pre",{style:m},d):null,S)}var _p=A.createElement(Cp,null),Up=class extends A.Component{constructor(s){super(s),this.state={location:s.location,revalidation:s.revalidation,error:s.error}}static getDerivedStateFromError(s){return{error:s}}static getDerivedStateFromProps(s,f){return f.location!==s.location||f.revalidation!=="idle"&&s.revalidation==="idle"?{error:s.error,location:s.location,revalidation:s.revalidation}:{error:s.error!==void 0?s.error:f.error,location:f.location,revalidation:s.revalidation||f.revalidation}}componentDidCatch(s,f){this.props.unstable_onError?this.props.unstable_onError(s,f):console.error("React Router caught the following error during render",s)}render(){return this.state.error!==void 0?A.createElement(Ft.Provider,{value:this.props.routeContext},A.createElement(Cc.Provider,{value:this.state.error,children:this.props.component})):this.props.children}};function Bp({routeContext:s,match:f,children:d}){let o=A.useContext(Ol);return o&&o.static&&o.staticContext&&(f.route.errorElement||f.route.ErrorBoundary)&&(o.staticContext._deepestRenderedBoundaryId=f.route.id),A.createElement(Ft.Provider,{value:s},d)}function Hp(s,f=[],d=null,o=null,m=null){if(s==null){if(!d)return null;if(d.errors)s=d.matches;else if(f.length===0&&!d.initialized&&d.matches.length>0)s=d.matches;else return null}let v=s,S=d?.errors;if(S!=null){let p=v.findIndex(w=>w.route.id&&S?.[w.route.id]!==void 0);Ne(p>=0,`Could not find a matching route for errors on route IDs: ${Object.keys(S).join(",")}`),v=v.slice(0,Math.min(v.length,p+1))}let T=!1,b=-1;if(d)for(let p=0;p<v.length;p++){let w=v[p];if((w.route.HydrateFallback||w.route.hydrateFallbackElement)&&(b=p),w.route.id){let{loaderData:B,errors:k}=d,M=w.route.loader&&!B.hasOwnProperty(w.route.id)&&(!k||k[w.route.id]===void 0);if(w.route.lazy||M){T=!0,b>=0?v=v.slice(0,b+1):v=[v[0]];break}}}return v.reduceRight((p,w,B)=>{let k,M=!1,Q=null,H=null;d&&(k=S&&w.route.id?S[w.route.id]:void 0,Q=w.route.errorElement||_p,T&&(b<0&&B===0?(um("route-fallback",!1,"No `HydrateFallback` element provided to render during initial hydration"),M=!0,H=null):b===B&&(M=!0,H=w.route.hydrateFallbackElement||null)));let U=f.concat(v.slice(0,B+1)),L=()=>{let G;return k?G=Q:M?G=H:w.route.Component?G=A.createElement(w.route.Component,null):w.route.element?G=w.route.element:G=p,A.createElement(Bp,{match:w,routeContext:{outlet:p,matches:U,isDataRoute:d!=null},children:G})};return d&&(w.route.ErrorBoundary||w.route.errorElement||B===0)?A.createElement(Up,{location:d.location,revalidation:d.revalidation,component:Q,error:k,children:L(),routeContext:{outlet:null,matches:U,isDataRoute:!0},unstable_onError:o}):L()},null)}function _c(s){return`${s} must be used within a data router.  See https://reactrouter.com/en/main/routers/picking-a-router.`}function kp(s){let f=A.useContext(Ol);return Ne(f,_c(s)),f}function Lp(s){let f=A.useContext(ir);return Ne(f,_c(s)),f}function qp(s){let f=A.useContext(Ft);return Ne(f,_c(s)),f}function Uc(s){let f=qp(s),d=f.matches[f.matches.length-1];return Ne(d.route.id,`${s} can only be used on routes that contain a unique "id"`),d.route.id}function Yp(){return Uc("useRouteId")}function Gp(){let s=A.useContext(Cc),f=Lp("useRouteError"),d=Uc("useRouteError");return s!==void 0?s:f.errors?.[d]}function Xp(){let{router:s}=kp("useNavigate"),f=Uc("useNavigate"),d=A.useRef(!1);return cm(()=>{d.current=!0}),A.useCallback(async(m,v={})=>{Rt(d.current,sm),d.current&&(typeof m=="number"?s.navigate(m):await s.navigate(m,{fromRouteId:f,...v}))},[s,f])}var Vf={};function um(s,f,d){!f&&!Vf[s]&&(Vf[s]=!0,Rt(!1,d))}A.memo(Qp);function Qp({routes:s,future:f,state:d,unstable_onError:o}){return om(s,void 0,d,o,f)}function Ga(s){Ne(!1,"A <Route> is only ever to be used as the child of <Routes> element, never rendered directly. Please wrap your <Route> in a <Routes>.")}function Vp({basename:s="/",children:f=null,location:d,navigationType:o="POP",navigator:m,static:v=!1}){Ne(!Bn(),"You cannot render a <Router> inside another <Router>. You should never have more than one in your app.");let S=s.replace(/^\/*/,"/"),T=A.useMemo(()=>({basename:S,navigator:m,static:v,future:{}}),[S,m,v]);typeof d=="string"&&(d=Rl(d));let{pathname:b="/",search:p="",hash:w="",state:B=null,key:k="default"}=d,M=A.useMemo(()=>{let Q=Jt(b,S);return Q==null?null:{location:{pathname:Q,search:p,hash:w,state:B,key:k},navigationType:o}},[S,b,p,w,B,k,o]);return Rt(M!=null,`<Router basename="${S}"> is not able to match the URL "${b}${p}${w}" because it does not start with the basename, so the <Router> won't render anything.`),M==null?null:A.createElement(Ot.Provider,{value:T},A.createElement(Un.Provider,{children:f,value:M}))}function Zp({children:s,location:f}){return Mp(Oc(s),f)}function Oc(s,f=[]){let d=[];return A.Children.forEach(s,(o,m)=>{if(!A.isValidElement(o))return;let v=[...f,m];if(o.type===A.Fragment){d.push.apply(d,Oc(o.props.children,v));return}Ne(o.type===Ga,`[${typeof o.type=="string"?o.type:o.type.name}] is not a <Route> component. All component children of <Routes> must be a <Route> or <React.Fragment>`),Ne(!o.props.index||!o.props.children,"An index route cannot have child routes.");let S={id:o.props.id||v.join("-"),caseSensitive:o.props.caseSensitive,element:o.props.element,Component:o.props.Component,index:o.props.index,path:o.props.path,loader:o.props.loader,action:o.props.action,hydrateFallbackElement:o.props.hydrateFallbackElement,HydrateFallback:o.props.HydrateFallback,errorElement:o.props.errorElement,ErrorBoundary:o.props.ErrorBoundary,hasErrorBoundary:o.props.hasErrorBoundary===!0||o.props.ErrorBoundary!=null||o.props.errorElement!=null,shouldRevalidate:o.props.shouldRevalidate,handle:o.props.handle,lazy:o.props.lazy};o.props.children&&(S.children=Oc(o.props.children,v)),d.push(S)}),d}var er="get",tr="application/x-www-form-urlencoded";function rr(s){return s!=null&&typeof s.tagName=="string"}function Kp(s){return rr(s)&&s.tagName.toLowerCase()==="button"}function Jp(s){return rr(s)&&s.tagName.toLowerCase()==="form"}function Fp(s){return rr(s)&&s.tagName.toLowerCase()==="input"}function Wp(s){return!!(s.metaKey||s.altKey||s.ctrlKey||s.shiftKey)}function $p(s,f){return s.button===0&&(!f||f==="_self")&&!Wp(s)}var Ii=null;function Pp(){if(Ii===null)try{new FormData(document.createElement("form"),0),Ii=!1}catch{Ii=!0}return Ii}var Ip=new Set(["application/x-www-form-urlencoded","multipart/form-data","text/plain"]);function Dc(s){return s!=null&&!Ip.has(s)?(Rt(!1,`"${s}" is not a valid \`encType\` for \`<Form>\`/\`<fetcher.Form>\` and will default to "${tr}"`),null):s}function ex(s,f){let d,o,m,v,S;if(Jp(s)){let T=s.getAttribute("action");o=T?Jt(T,f):null,d=s.getAttribute("method")||er,m=Dc(s.getAttribute("enctype"))||tr,v=new FormData(s)}else if(Kp(s)||Fp(s)&&(s.type==="submit"||s.type==="image")){let T=s.form;if(T==null)throw new Error('Cannot submit a <button> or <input type="submit"> without a <form>');let b=s.getAttribute("formaction")||T.getAttribute("action");if(o=b?Jt(b,f):null,d=s.getAttribute("formmethod")||T.getAttribute("method")||er,m=Dc(s.getAttribute("formenctype"))||Dc(T.getAttribute("enctype"))||tr,v=new FormData(T,s),!Pp()){let{name:p,type:w,value:B}=s;if(w==="image"){let k=p?`${p}.`:"";v.append(`${k}x`,"0"),v.append(`${k}y`,"0")}else p&&v.append(p,B)}}else{if(rr(s))throw new Error('Cannot submit element that is not <form>, <button>, or <input type="submit|image">');d=er,o=null,m=tr,S=s}return v&&m==="text/plain"&&(S=v,v=void 0),{action:o,method:d.toLowerCase(),encType:m,formData:v,body:S}}Object.getOwnPropertyNames(Object.prototype).sort().join("\0");function Bc(s,f){if(s===!1||s===null||typeof s>"u")throw new Error(f)}function tx(s,f,d){let o=typeof s=="string"?new URL(s,typeof window>"u"?"server://singlefetch/":window.location.origin):s;return o.pathname==="/"?o.pathname=`_root.${d}`:f&&Jt(o.pathname,f)==="/"?o.pathname=`${f.replace(/\/$/,"")}/_root.${d}`:o.pathname=`${o.pathname.replace(/\/$/,"")}.${d}`,o}async function ax(s,f){if(s.id in f)return f[s.id];try{let d=await import(s.module);return f[s.id]=d,d}catch(d){return console.error(`Error loading route module \`${s.module}\`, reloading page...`),console.error(d),window.__reactRouterContext&&window.__reactRouterContext.isSpaMode,window.location.reload(),new Promise(()=>{})}}function lx(s){return s==null?!1:s.href==null?s.rel==="preload"&&typeof s.imageSrcSet=="string"&&typeof s.imageSizes=="string":typeof s.rel=="string"&&typeof s.href=="string"}async function nx(s,f,d){let o=await Promise.all(s.map(async m=>{let v=f.routes[m.route.id];if(v){let S=await ax(v,d);return S.links?S.links():[]}return[]}));return cx(o.flat(1).filter(lx).filter(m=>m.rel==="stylesheet"||m.rel==="preload").map(m=>m.rel==="stylesheet"?{...m,rel:"prefetch",as:"style"}:{...m,rel:"prefetch"}))}function Zf(s,f,d,o,m,v){let S=(b,p)=>d[p]?b.route.id!==d[p].route.id:!0,T=(b,p)=>d[p].pathname!==b.pathname||d[p].route.path?.endsWith("*")&&d[p].params["*"]!==b.params["*"];return v==="assets"?f.filter((b,p)=>S(b,p)||T(b,p)):v==="data"?f.filter((b,p)=>{let w=o.routes[b.route.id];if(!w||!w.hasLoader)return!1;if(S(b,p)||T(b,p))return!0;if(b.route.shouldRevalidate){let B=b.route.shouldRevalidate({currentUrl:new URL(m.pathname+m.search+m.hash,window.origin),currentParams:d[0]?.params||{},nextUrl:new URL(s,window.origin),nextParams:b.params,defaultShouldRevalidate:!0});if(typeof B=="boolean")return B}return!0}):[]}function ix(s,f,{includeHydrateFallback:d}={}){return rx(s.map(o=>{let m=f.routes[o.route.id];if(!m)return[];let v=[m.module];return m.clientActionModule&&(v=v.concat(m.clientActionModule)),m.clientLoaderModule&&(v=v.concat(m.clientLoaderModule)),d&&m.hydrateFallbackModule&&(v=v.concat(m.hydrateFallbackModule)),m.imports&&(v=v.concat(m.imports)),v}).flat(1))}function rx(s){return[...new Set(s)]}function sx(s){let f={},d=Object.keys(s).sort();for(let o of d)f[o]=s[o];return f}function cx(s,f){let d=new Set;return new Set(f),s.reduce((o,m)=>{let v=JSON.stringify(sx(m));return d.has(v)||(d.add(v),o.push({key:v,link:m})),o},[])}function dm(){let s=A.useContext(Ol);return Bc(s,"You must render this element inside a <DataRouterContext.Provider> element"),s}function ox(){let s=A.useContext(ir);return Bc(s,"You must render this element inside a <DataRouterStateContext.Provider> element"),s}var Hc=A.createContext(void 0);Hc.displayName="FrameworkContext";function fm(){let s=A.useContext(Hc);return Bc(s,"You must render this element inside a <HydratedRouter> element"),s}function ux(s,f){let d=A.useContext(Hc),[o,m]=A.useState(!1),[v,S]=A.useState(!1),{onFocus:T,onBlur:b,onMouseEnter:p,onMouseLeave:w,onTouchStart:B}=f,k=A.useRef(null);A.useEffect(()=>{if(s==="render"&&S(!0),s==="viewport"){let H=L=>{L.forEach(G=>{S(G.isIntersecting)})},U=new IntersectionObserver(H,{threshold:.5});return k.current&&U.observe(k.current),()=>{U.disconnect()}}},[s]),A.useEffect(()=>{if(o){let H=setTimeout(()=>{S(!0)},100);return()=>{clearTimeout(H)}}},[o]);let M=()=>{m(!0)},Q=()=>{m(!1),S(!1)};return d?s!=="intent"?[v,k,{}]:[v,k,{onFocus:Mn(T,M),onBlur:Mn(b,Q),onMouseEnter:Mn(p,M),onMouseLeave:Mn(w,Q),onTouchStart:Mn(B,M)}]:[!1,k,{}]}function Mn(s,f){return d=>{s&&s(d),d.defaultPrevented||f(d)}}function dx({page:s,...f}){let{router:d}=dm(),o=A.useMemo(()=>em(d.routes,s,d.basename),[d.routes,s,d.basename]);return o?A.createElement(mx,{page:s,matches:o,...f}):null}function fx(s){let{manifest:f,routeModules:d}=fm(),[o,m]=A.useState([]);return A.useEffect(()=>{let v=!1;return nx(s,f,d).then(S=>{v||m(S)}),()=>{v=!0}},[s,f,d]),o}function mx({page:s,matches:f,...d}){let o=Wt(),{manifest:m,routeModules:v}=fm(),{basename:S}=dm(),{loaderData:T,matches:b}=ox(),p=A.useMemo(()=>Zf(s,f,b,m,o,"data"),[s,f,b,m,o]),w=A.useMemo(()=>Zf(s,f,b,m,o,"assets"),[s,f,b,m,o]),B=A.useMemo(()=>{if(s===o.pathname+o.search+o.hash)return[];let Q=new Set,H=!1;if(f.forEach(L=>{let G=m.routes[L.route.id];!G||!G.hasLoader||(!p.some($=>$.route.id===L.route.id)&&L.route.id in T&&v[L.route.id]?.shouldRevalidate||G.hasClientLoader?H=!0:Q.add(L.route.id))}),Q.size===0)return[];let U=tx(s,S,"data");return H&&Q.size>0&&U.searchParams.set("_routes",f.filter(L=>Q.has(L.route.id)).map(L=>L.route.id).join(",")),[U.pathname+U.search]},[S,T,o,m,p,f,s,v]),k=A.useMemo(()=>ix(w,m),[w,m]),M=fx(w);return A.createElement(A.Fragment,null,B.map(Q=>A.createElement("link",{key:Q,rel:"prefetch",as:"fetch",href:Q,...d})),k.map(Q=>A.createElement("link",{key:Q,rel:"modulepreload",href:Q,...d})),M.map(({key:Q,link:H})=>A.createElement("link",{key:Q,nonce:d.nonce,...H})))}function hx(...s){return f=>{s.forEach(d=>{typeof d=="function"?d(f):d!=null&&(d.current=f)})}}var mm=typeof window<"u"&&typeof window.document<"u"&&typeof window.document.createElement<"u";try{mm&&(window.__reactRouterVersion="7.9.1")}catch{}function px({basename:s,children:f,window:d}){let o=A.useRef();o.current==null&&(o.current=ap({window:d,v5Compat:!0}));let m=o.current,[v,S]=A.useState({action:m.action,location:m.location}),T=A.useCallback(b=>{A.startTransition(()=>S(b))},[S]);return A.useLayoutEffect(()=>m.listen(T),[m,T]),A.createElement(Vp,{basename:s,children:f,location:v.location,navigationType:v.action,navigator:m})}var hm=/^(?:[a-z][a-z0-9+.-]*:|\/\/)/i,Xa=A.forwardRef(function({onClick:f,discover:d="render",prefetch:o="none",relative:m,reloadDocument:v,replace:S,state:T,target:b,to:p,preventScrollReset:w,viewTransition:B,...k},M){let{basename:Q}=A.useContext(Ot),H=typeof p=="string"&&hm.test(p),U,L=!1;if(typeof p=="string"&&H&&(U=p,mm))try{let we=new URL(window.location.href),et=p.startsWith("//")?new URL(we.protocol+p):new URL(p),dt=Jt(et.pathname,Q);et.origin===we.origin&&dt!=null?p=dt+et.search+et.hash:L=!0}catch{Rt(!1,`<Link to="${p}"> contains an invalid URL which will probably break when clicked - please update to a valid URL path.`)}let G=Dp(p,{relative:m}),[$,ye,I]=ux(o,k),_e=bx(p,{replace:S,state:T,target:b,preventScrollReset:w,relative:m,viewTransition:B});function Re(we){f&&f(we),we.defaultPrevented||_e(we)}let Ue=A.createElement("a",{...k,...I,href:U||G,onClick:L||v?f:Re,ref:hx(M,ye),target:b,"data-discover":!H&&d==="render"?"true":void 0});return $&&!H?A.createElement(A.Fragment,null,Ue,A.createElement(dx,{page:G})):Ue});Xa.displayName="Link";var xx=A.forwardRef(function({"aria-current":f="page",caseSensitive:d=!1,className:o="",end:m=!1,style:v,to:S,viewTransition:T,children:b,...p},w){let B=Hn(S,{relative:p.relative}),k=Wt(),M=A.useContext(ir),{navigator:Q,basename:H}=A.useContext(Ot),U=M!=null&&Sx(B)&&T===!0,L=Q.encodeLocation?Q.encodeLocation(B).pathname:B.pathname,G=k.pathname,$=M&&M.navigation&&M.navigation.location?M.navigation.location.pathname:null;d||(G=G.toLowerCase(),$=$?$.toLowerCase():null,L=L.toLowerCase()),$&&H&&($=Jt($,H)||$);const ye=L!=="/"&&L.endsWith("/")?L.length-1:L.length;let I=G===L||!m&&G.startsWith(L)&&G.charAt(ye)==="/",_e=$!=null&&($===L||!m&&$.startsWith(L)&&$.charAt(L.length)==="/"),Re={isActive:I,isPending:_e,isTransitioning:U},Ue=I?f:void 0,we;typeof o=="function"?we=o(Re):we=[o,I?"active":null,_e?"pending":null,U?"transitioning":null].filter(Boolean).join(" ");let et=typeof v=="function"?v(Re):v;return A.createElement(Xa,{...p,"aria-current":Ue,className:we,ref:w,style:et,to:S,viewTransition:T},typeof b=="function"?b(Re):b)});xx.displayName="NavLink";var gx=A.forwardRef(({discover:s="render",fetcherKey:f,navigate:d,reloadDocument:o,replace:m,state:v,method:S=er,action:T,onSubmit:b,relative:p,preventScrollReset:w,viewTransition:B,...k},M)=>{let Q=Nx(),H=wx(T,{relative:p}),U=S.toLowerCase()==="get"?"get":"post",L=typeof T=="string"&&hm.test(T),G=$=>{if(b&&b($),$.defaultPrevented)return;$.preventDefault();let ye=$.nativeEvent.submitter,I=ye?.getAttribute("formmethod")||S;Q(ye||$.currentTarget,{fetcherKey:f,method:I,navigate:d,replace:m,state:v,relative:p,preventScrollReset:w,viewTransition:B})};return A.createElement("form",{ref:M,method:U,action:H,onSubmit:o?b:G,...k,"data-discover":!L&&s==="render"?"true":void 0})});gx.displayName="Form";function vx(s){return`${s} must be used within a data router.  See https://reactrouter.com/en/main/routers/picking-a-router.`}function pm(s){let f=A.useContext(Ol);return Ne(f,vx(s)),f}function bx(s,{target:f,replace:d,state:o,preventScrollReset:m,relative:v,viewTransition:S}={}){let T=Rp(),b=Wt(),p=Hn(s,{relative:v});return A.useCallback(w=>{if($p(w,f)){w.preventDefault();let B=d!==void 0?d:_n(b)===_n(p);T(s,{replace:B,state:o,preventScrollReset:m,relative:v,viewTransition:S})}},[b,T,p,d,o,f,s,m,v,S])}var yx=0,jx=()=>`__${String(++yx)}__`;function Nx(){let{router:s}=pm("useSubmit"),{basename:f}=A.useContext(Ot),d=Yp();return A.useCallback(async(o,m={})=>{let{action:v,method:S,encType:T,formData:b,body:p}=ex(o,f);if(m.navigate===!1){let w=m.fetcherKey||jx();await s.fetch(w,d,m.action||v,{preventScrollReset:m.preventScrollReset,formData:b,body:p,formMethod:m.method||S,formEncType:m.encType||T,flushSync:m.flushSync})}else await s.navigate(m.action||v,{preventScrollReset:m.preventScrollReset,formData:b,body:p,formMethod:m.method||S,formEncType:m.encType||T,replace:m.replace,state:m.state,fromRouteId:d,flushSync:m.flushSync,viewTransition:m.viewTransition})},[s,f,d])}function wx(s,{relative:f}={}){let{basename:d}=A.useContext(Ot),o=A.useContext(Ft);Ne(o,"useFormAction must be used inside a RouteContext");let[m]=o.matches.slice(-1),v={...Hn(s||".",{relative:f})},S=Wt();if(s==null){v.search=S.search;let T=new URLSearchParams(v.search),b=T.getAll("index");if(b.some(w=>w==="")){T.delete("index"),b.filter(B=>B).forEach(B=>T.append("index",B));let w=T.toString();v.search=w?`?${w}`:""}}return(!s||s===".")&&m.route.index&&(v.search=v.search?v.search.replace(/^\?/,"?index&"):"?index"),d!=="/"&&(v.pathname=v.pathname==="/"?d:Kt([d,v.pathname])),_n(v)}function Sx(s,{relative:f}={}){let d=A.useContext(rm);Ne(d!=null,"`useViewTransitionState` must be used within `react-router-dom`'s `RouterProvider`.  Did you accidentally import `RouterProvider` from `react-router`?");let{basename:o}=pm("useViewTransitionState"),m=Hn(s,{relative:f});if(!d.isTransitioning)return!1;let v=Jt(d.currentLocation.pathname,o)||d.currentLocation.pathname,S=Jt(d.nextLocation.pathname,o)||d.nextLocation.pathname;return ar(m.pathname,S)!=null||ar(m.pathname,v)!=null}const Ex="/assets/Screenshot_20250920-003837-removebg-preview-DldVoMcW.png",zx=()=>{const[s,f]=A.useState(!1),[d,o]=A.useState(!1),m=Wt(),v=()=>{f(!1)};A.useEffect(()=>{const b=()=>{window.scrollY>10?o(!0):o(!1)};return window.addEventListener("scroll",b),()=>window.removeEventListener("scroll",b)},[]);const S=[{path:"/",label:"Home"},{path:"/about",label:"About"},{path:"/services",label:"Services"},{path:"/team",label:"Portfolio"},{path:"/contact",label:"Contact"}],T=b=>m.pathname===b;return i.jsxs("div",{children:[i.jsx("nav",{className:`navbar fixed w-full z-50 transition-all duration-300 ${d?"bg-black/95 backdrop-blur-md shadow-xl py-1":"bg-transparent py-2"}`,style:{backgroundColor:"#101828"},children:i.jsxs("div",{className:"max-w-7xl mx-auto px-3 sm:px-4 lg:px-8",children:[i.jsxs("div",{className:"flex items-center justify-between h-14 md:h-16 lg:h-20",children:[i.jsx(Xa,{to:"/",className:"flex-shrink-0 z-10",onClick:v,children:i.jsx("div",{className:"logo-container group",children:i.jsx("img",{src:Ex,className:"logo-image transition-all duration-300 group-hover:scale-105 group-hover:rotate-1",alt:"Resicode Logo",style:{height:"50px",width:"auto",filter:"drop-shadow(0 1px 2px rgba(0,0,0,0.5))"}})})}),i.jsx("div",{className:"hidden lg:flex flex-1 items-center justify-center",children:i.jsx("div",{className:"flex items-center space-x-1 bg-gray-900/50 backdrop-blur-sm rounded-full p-1 border border-gray-800",children:S.map(b=>i.jsxs(Xa,{to:b.path,className:`nav-link relative px-5 py-2.5 rounded-full text-sm font-medium transition-all duration-200 ${T(b.path)?"text-white bg-gradient-to-r from-purple-600 to-pink-600 shadow-md":"text-gray-300 hover:text-white hover:bg-gray-800/50"}`,onClick:v,children:[b.label,T(b.path)&&i.jsx("span",{className:"absolute -bottom-1 left-1/2 transform -translate-x-1/2 w-1.5 h-1.5 bg-yellow-400 rounded-full animate-pulse"})]},b.path))})}),i.jsx("div",{className:"hidden lg:block flex-shrink-0",children:i.jsx(Xa,{to:"/careers",children:i.jsxs("button",{type:"button",className:"careers-btn group relative px-6 py-2.5 rounded-full text-white font-bold text-sm tracking-wider transition-all duration-300 ease-out transform hover:scale-105 hover:shadow-xl overflow-hidden",onClick:v,children:[i.jsx("div",{className:"absolute inset-0 bg-gradient-to-r from-yellow-500 via-orange-500 to-pink-500 rounded-full opacity-100 group-hover:opacity-90 transition-opacity duration-300"}),i.jsx("div",{className:"absolute inset-0 bg-gradient-to-r from-transparent via-white/20 to-transparent -translate-x-full group-hover:translate-x-full transition-transform duration-700"}),i.jsxs("span",{className:"relative flex items-center",children:[i.jsx("svg",{className:"w-3.5 h-3.5 mr-1.5 transition-transform duration-200 group-hover:rotate-12",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",xmlns:"http://www.w3.org/2000/svg",children:i.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:"2",d:"M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2 2v2m4 6h.01M5 20h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"})}),"Careers"]})]})})}),i.jsx("div",{className:"lg:hidden flex items-center",children:i.jsx("button",{type:"button",onClick:()=>f(!s),className:"inline-flex items-center justify-center p-1.5 rounded-full text-gray-400 hover:text-white hover:bg-gray-800 transition-all duration-200 focus:outline-none","aria-label":"Toggle menu","aria-expanded":s,children:i.jsx("svg",{className:`w-5 h-5 transform transition-transform duration-200 ${s?"rotate-180":""}`,fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:s?i.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:"2",d:"M6 18L18 6M6 6l12 12"}):i.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:"2",d:"M4 6h16M4 12h16M4 18h16"})})})})]}),i.jsx("div",{className:`lg:hidden transition-all duration-200 ease-in-out ${s?"max-h-80 opacity-100 mt-1":"max-h-0 opacity-0 overflow-hidden"}`,children:i.jsxs("div",{className:"px-2 pt-1 pb-2 space-y-0.5 bg-gray-900/95 backdrop-blur-lg rounded-lg border border-gray-800 shadow-lg",children:[S.map(b=>i.jsx(Xa,{to:b.path,className:`nav-link-mobile block px-3 py-2 rounded-md text-sm font-medium transition-all duration-150 ${T(b.path)?"text-white bg-gradient-to-r from-purple-600 to-pink-600":"text-gray-300 hover:text-white hover:bg-gray-800/50"}`,onClick:v,children:i.jsxs("div",{className:"flex items-center",children:[i.jsx("span",{className:"flex-1",children:b.label}),T(b.path)&&i.jsx("span",{className:"w-1.5 h-1.5 bg-yellow-400 rounded-full animate-pulse"})]})},b.path)),i.jsx(Xa,{to:"/careers",onClick:v,children:i.jsxs("button",{type:"button",className:"w-full mt-2 px-4 py-2.5 rounded-lg text-white font-bold text-sm bg-gradient-to-r from-yellow-500 via-orange-500 to-pink-500 hover:from-yellow-600 hover:via-orange-600 hover:to-pink-600 transition-all duration-200 transform hover:scale-[1.02] shadow-md flex items-center justify-center",children:[i.jsx("svg",{className:"w-4 h-4 mr-1.5",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",xmlns:"http://www.w3.org/2000/svg",children:i.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:"2",d:"M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2 2v2m4 6h.01M5 20h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"})}),"Careers"]})})]})})]})}),i.jsx("div",{className:"nav-spacer",style:{height:"56px"}}),i.jsx("style",{jsx:!0,children:`
        .navbar {
...
.learn-more-btn:hover .arrow-icon {
  transform: translateX(4px);
      ...
      `})]})},og=()=>{const[s,f]=A.useState({name:"",email:"",phone:"",serviceType:"",subject:"",message:""}),[d,o]=A.useState(!1),[m,v]=A.useState({}),[S,T]=A.useState(""),[b,p]=A.useState(""),w="https://resicode-backend.onrender.com",B=["Web Development","Mobile App Development","UI/UX Design","Digital Marketing","Consulting","Other"],k=U=>{const{name:L,value:G}=U.target;f({...s,[L]:G}),m[L]&&v({...m,[L]:""}),S&&T(""),b&&p("")},M=()=>{const U={};return s.name.trim()||(U.name="Name is required"),s.email.trim()?/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(s.email)||(U.email="Please enter a valid email"):U.email="Email is required",s.message.trim()||(U.message="Message is required"),U},Q=async U=>{U.preventDefault();const L=M();if(Object.keys(L).length>0){v(L);return}o(!0),p(""),T("");try{console.log(`📤 Sending to: ${w}/api/contact/send`);const G=await fetch(`${w}/api/contact/send`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(s)}),$=await G.json();console.log("📥 Response:",$),G.ok&&$.success?(T($.message||"Message sent successfully!"),f({name:"",email:"",phone:"",serviceType:"",subject:"",message:""})):p($.message||"Failed to send message. Please try again.")}catch(G){console.error("❌ Connection error:",G),p(`Failed to connect to server: ${G.message}`)}finally{o(!1)}},H=async()=>{try{p(""),T("");const U=await fetch(`${w}/api/health`);if(U.ok){const L=await U.json();T(`✅ Backend connected! Status: ${L.status}`),console.log("Backend health:",L)}else p(`❌ Backend returned error: ${U.status}`)}catch(U){p(`❌ Cannot connect to backend: ${U.message}`)}};return i.jsxs("div",{className:"p-8 max-w-6xl mx-auto",children:[i.jsxs("h1",{className:"text-4xl font-bold text-white mb-8 text-center",children:["Contact ",i.jsx("span",{className:"text-yellow-300",children:"RESICODE"})]}),i.jsx("div",{className:"mb-6 p-4 bg-gray-800/50 border border-gray-700 rounded-lg",children:i.jsxs("div",{className:"flex flex-col md:flex-row justify-between items-center gap-4",children:[i.jsxs("div",{children:[i.jsx("h3",{className:"text-lg font-bold text-white mb-1",children:"Backend Status"}),i.jsxs("p",{className:"text-gray-300 text-sm",children:["URL: ",i.jsx("code",{className:"bg-gray-900 px-2 py-1 rounded",children:w})]})]}),i.jsx("button",{onClick:H,className:"px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors",children:"Test Connection"})]})}),S&&i.jsx("div",{className:"mb-6 p-4 bg-green-900/30 border border-green-700 rounded-lg",children:i.jsxs("div",{className:"flex items-center",children:[i.jsx("svg",{className:"w-5 h-5 text-green-400 mr-2",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:i.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M5 13l4 4L19 7"})}),i.jsx("span",{className:"text-green-300",children:S})]})}),b&&i.jsx("div",{className:"mb-6 p-4 bg-red-900/30 border border-red-700 rounded-lg",children:i.jsxs("div",{className:"flex items-center",children:[i.jsx("svg",{className:"w-5 h-5 text-red-400 mr-2",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:i.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"})}),i.jsx("span",{className:"text-red-300",children:b})]})}),i.jsxs("div",{className:"bg-gray-800 rounded-xl p-8 border border-gray-700",children:[i.jsx("h2",{className:"text-2xl font-bold text-white mb-6",children:"Send Message"}),i.jsxs("form",{onSubmit:Q,className:"space-y-6",children:[i.jsxs("div",{className:"grid grid-cols-1 md:grid-cols-2 gap-6",children:[i.jsxs("div",{children:[i.jsx("label",{className:"block text-gray-300 mb-2",children:"Full Name *"}),i.jsx("input",{type:"text",name:"name",value:s.name,onChange:k,className:"w-full bg-gray-900 border border-gray-700 rounded-lg p-3 text-white focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:border-transparent",placeholder:"Your name"}),m.name&&i.jsx("p",{className:"text-red-400 text-sm mt-1",children:m.name})]}),i.jsxs("div",{children:[i.jsx("label",{className:"block text-gray-300 mb-2",children:"Email *"}),i.jsx("input",{type:"email",name:"email",value:s.email,onChange:k,className:"w-full bg-gray-900 border border-gray-700 rounded-lg p-3 text-white focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:border-transparent",placeholder:"your@email.com"}),m.email&&i.jsx("p",{className:"text-red-400 text-sm mt-1",children:m.email})]})]}),i.jsxs("div",{className:"grid grid-cols-1 md:grid-cols-2 gap-6",children:[i.jsxs("div",{children:[i.jsx("label",{className:"block text-gray-300 mb-2",children:"Phone"}),i.jsx("input",{type:"tel",name:"phone",value:s.phone,onChange:k,className:"w-full bg-gray-900 border border-gray-700 rounded-lg p-3 text-white focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:border-transparent",placeholder:"+91 1234567890"})]}),i.jsxs("div",{children:[i.jsx("label",{className:"block text-gray-300 mb-2",children:"Service Type"}),i.jsxs("select",{name:"serviceType",value:s.serviceType,onChange:k,className:"w-full bg-gray-900 border border-gray-700 rounded-lg p-3 text-white focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:border-transparent",children:[i.jsx("option",{value:"",children:"Select Service"}),B.map((U,L)=>i.jsx("option",{value:U,children:U},L))]})]})]}),i.jsxs("div",{children:[i.jsx("label",{className:"block text-gray-300 mb-2",children:"Subject"}),i.jsx("input",{type:"text",name:"subject",value:s.subject,onChange:k,className:"w-full bg-gray-900 border border-gray-700 rounded-lg p-3 text-white focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:border-transparent",placeholder:"Subject of your message"})]}),i.jsxs("div",{children:[i.jsx("label",{className:"block text-gray-300 mb-2",children:"Message *"}),i.jsx("textarea",{name:"message",rows:"5",value:s.message,onChange:k,className:"w-full bg-gray-900 border border-gray-700 rounded-lg p-3 text-white focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:border-transparent",placeholder:"Your message here..."}),m.message&&i.jsx("p",{className:"text-red-400 text-sm mt-1",children:m.message})]}),i.jsx("button",{type:"submit",disabled:d,className:`
              w-full py-4 rounded-lg font-bold text-lg transition-all duration-300
              ${d?"bg-gray-600 text-gray-400 cursor-not-allowed":"bg-yellow-300 text-black hover:bg-yellow-400 hover:scale-[1.02] active:scale-[0.98]"}
            `,children:d?i.jsxs("div",{className:"flex items-center justify-center",children:[i.jsxs("svg",{className:"animate-spin h-5 w-5 mr-3 text-black",xmlns:"http://www.w3.org/2000/svg",fill:"none",viewBox:"0 0 24 24",children:[i.jsx("circle",{className:"opacity-25",cx:"12",cy:"12",r:"10",stroke:"currentColor",strokeWidth:"4"}),i.jsx("path",{className:"opacity-75",fill:"currentColor",d:"M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"})]}),"Sending..."]}):"Send Message"})]})]}),i.jsxs("div",{className:"mt-8 p-6 bg-yellow-900/20 border border-yellow-700 rounded-xl",children:[i.jsx("h3",{className:"text-xl font-bold text-yellow-300 mb-3",children:"🔧 Troubleshooting"}),i.jsxs("div",{className:"text-yellow-200 space-y-2",children:[i.jsx("p",{children:"If you're getting connection errors:"}),i.jsxs("ol",{className:"list-decimal ml-5 space-y-1",children:[i.jsx("li",{children:"Make sure your backend is running on Render"}),i.jsxs("li",{children:["Check if the backend URL is correct: ",i.jsx("code",{className:"bg-gray-900 px-2 py-1 rounded text-sm",children:w})]}),i.jsx("li",{children:'Click the "Test Connection" button above to verify'}),i.jsx("li",{children:"Make sure CORS is properly configured on your backend"})]})]})]})]})},ug="/assets/E-com-4J2yBeiD.png",dg=()=>i.jsx("div",{children:i.jsxs("div",{class:"min-h-screen bg-gray-800 mt-1",children:[i.jsx("h2",{className:"text-4xl font-bold  text-center mb-8 p-5",style:{color:"white"},children:"Our Services"}),i.jsxs("div",{className:"grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto px-4 p-5",children:[i.jsxs("div",{className:"bg-gray-800 border border-gray-700 rounded-xl p-6 hover:shadow-2xl transition duration-300 hover:-translate-y-2",children:[i.jsx("img",{src:vm,alt:"Web Development",className:"w-25 h-25 mb-4 mx-auto"}),i.jsx("h3",{className:"text-2xl font-bold text-[#F45DA2] mb-3 text-center",children:"Web Development"}),i.jsx("p",{className:"text-gray-300 text-center",children:"Custom static and dynamic websites built with modern technologies for optimal performance and user experience. Responsive Design Fast Loading SEO Optimized"}),i.jsx("button",{className:"mt-4 bg-yellow-500 text-black font-bold py-2 px-4 rounded-lg hover:bg-yellow-600 transition duration-300 block mx-auto",children:"Learn More"})]}),i.jsxs("div",{className:"bg-gray-800 border border-gray-700 rounded-xl p-6 hover:shadow-2xl transition duration-300 hover:-translate-y-2",children:[i.jsx("img",{src:ug,alt:"E-commerce Solutions",className:"w-25 h-25 mb-4 mx-auto"}),i.jsx("h3",{className:"text-2xl font-bold text-[#FBDB57] mb-3 text-center",children:"E-commerce Solutions"}),i.jsx("p",{className:"text-gray-300 text-center",children:"Complete online store solutions with secure payment gateways, inventory management, and seamless user journey. Payment Integration Inventory Management Mobile Friendly"}),i.jsx("button",{className:"mt-4 bg-yellow-500 text-black font-bold py-2 px-4 rounded-lg hover:bg-yellow-600 transition duration-300 block mx-auto",children:"Learn More"})]}),i.jsxs("div",{className:"bg-gray-800 border border-gray-700 rounded-xl p-6 hover:shadow-2xl transition duration-300 hover:-translate-y-2",children:[i.jsx("img",{src:ym,alt:"UI/UX Design",className:"w-25 h-25 mb-4 mx-auto"}),i.jsx("h3",{className:"text-2xl font-bold text-[#FBDB57] mb-3 text-center",children:"UI / UX Design"}),i.jsx("p",{className:"text-gray-300 text-center",children:"User-centered designs that create intuitive, engaging experiences and drive conversions for your business. User Research Wireframing"}),i.jsx("button",{className:"mt-4 bg-yellow-500 text-black font-bold py-2 px-4 rounded-lg hover:bg-yellow-600 transition duration-300 block mx-auto",children:"Learn More"})]}),i.jsxs("div",{className:"bg-gray-800 border border-gray-700 rounded-xl p-6 hover:shadow-2xl transition duration-300 hover:-translate-y-2",children:[i.jsx("img",{src:bm,alt:"Web App Development",className:"w-25 h-25 mb-4 mx-auto"}),i.jsx("h3",{className:"text-2xl font-bold text-[#FBDB57] mb-3 text-center",children:"Web App Development"}),i.jsx("p",{className:"text-gray-300 text-center",children:"Scalable web applications with robust backend systems, real-time features, and cross-platform compatibility. Real-time Features API Integration Progressive Web Apps"}),i.jsx("button",{className:"mt-4 bg-yellow-500 text-black font-bold py-2 px-4 rounded-lg hover:bg-yellow-600 transition duration-300 block mx-auto",children:"Learn More"})]}),i.jsxs("div",{className:"bg-gray-800 border border-gray-700 rounded-xl p-6 hover:shadow-2xl transition duration-300 hover:-translate-y-2",children:[i.jsx("img",{src:jm,alt:"SEO & Website Maintenance",className:"w-25 h-25 mb-4 mx-auto"}),i.jsx("h3",{className:"text-2xl font-bold text-[#FBDB57] mb-3 text-center",children:"SEO & Website Maintenance"}),i.jsx("p",{className:"text-gray-300 text-center",children:"Continuous optimization, security updates, and performance monitoring to keep your website at peak performance. SEO Optimization Security Updates Performance Monitoring"}),i.jsx("button",{className:"mt-4 bg-yellow-500 text-black font-bold py-2 px-4 rounded-lg hover:bg-yellow-600 transition duration-300 block mx-auto",children:"Learn More"})]}),i.jsxs("div",{className:"bg-gray-800 border border-gray-700 rounded-xl p-6 hover:shadow-2xl transition duration-300 hover:-translate-y-2",children:[i.jsx("img",{src:Nm,alt:"Custom Solutions",className:"w-25 h-25 mb-4 mx-auto"}),i.jsx("h3",{className:"text-2xl font-bold text-[#45CFFF] mb-3 text-center",children:"Custom Solutions"}),i.jsx("p",{className:"text-gray-300 text-center",children:"Tailored software solutions designed to meet your unique business requirements and workflow needs. Custom Software API Development System Integration"}),i.jsx("button",{className:"mt-4 bg-yellow-500 text-black font-bold py-2 px-4 rounded-lg hover:bg-yellow-600 transition duration-300 block mx-auto",children:"Learn More"})]})]})]})}),fg=()=>{const s=[{id:"01",title:"Consultation",color:"text-[#F45DA2]"},{id:"02",title:"Planning",color:"text-[#FBDB57]"},{id:"03",title:"Design & Development",color:"text-[#45CFFF]"},{id:"04",title:"Testing",color:"text-[#F45DA2]"},{id:"05",title:"Launch & Support",color:"text-[#FBDB57]"},{id:"06",title:"Optimization",color:"text-[#45CFFF]"}];return i.jsx("section",{className:"bg-gray-900 py-20 px-4",children:i.jsxs("div",{className:"max-w-7xl mx-auto",children:[i.jsxs("div",{className:"text-center mb-14",children:[i.jsx("h2",{className:"text-4xl md:text-5xl font-bold text-white mb-4",children:"Our Process"}),i.jsx("p",{className:"text-gray-400 max-w-2xl mx-auto",children:"A structured approach that ensures quality, speed, and long-term success."})]}),i.jsx("div",{className:"grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10",children:s.map(f=>i.jsxs("div",{className:`group bg-white/5 backdrop-blur-xl border border-white/10 \r
              rounded-2xl p-8 text-center transition-all duration-500\r
              hover:-translate-y-3 hover:shadow-[0_25px_60px_rgba(0,0,0,0.5)]`,children:[i.jsx("div",{className:`text-5xl font-extrabold mb-6 ${f.color} opacity-90`,children:f.id}),i.jsx("h3",{className:"text-xl font-semibold text-white mb-3",children:f.title}),i.jsx("div",{className:"w-12 h-1 mx-auto rounded-full bg-gradient-to-r from-pink-500 via-yellow-400 to-cyan-400 opacity-70 group-hover:w-20 transition-all duration-500"})]},f.id))})]})})},mg="/assets/ather-DjQeWt0B.jpg",hg=()=>i.jsx("section",{className:"bg-gray-900 py-20 px-4 mt-1",children:i.jsxs("div",{className:"max-w-6xl mx-auto text-center",children:[i.jsxs("h2",{className:"text-3xl md:text-5xl font-bold text-white mb-4",children:["Ready to Start Your Project with"," ",i.jsx("span",{className:"text-yellow-300",children:"Resicode?"})]}),i.jsx("p",{className:"text-gray-300 text-lg md:text-xl max-w-3xl mx-auto mb-10",children:"Let’s transform your ideas into a powerful digital solution. Get started with a free consultation and see how we help businesses grow."}),i.jsx("div",{className:"mb-16",children:i.jsx("button",{className:`bg-yellow-300 text-black font-bold py-3 px-8 rounded-xl \r
...
.animate-marquee {
  animation: marquee 20s linear infinite;
    ...
    `})]})})}const vg=()=>{const[s,f]=A.useState("all"),[d,o]=A.useState({fullName:"",email:"",phone:"",position:"",experience:"",resume:null,coverLetter:"",portfolio:"",linkedin:"",referral:"",noticePeriod:"immediate"}),[m,v]=A.useState(!1),[S,T]=A.useState(!1),[b,p]=A.useState(null),w=[{id:1,title:"Senior Full Stack Developer",department:"Engineering",type:"Full-time",location:"Nagpur, Maharashtra",experience:"3-5 years",postedDate:"2 days ago",description:"We're looking for an experienced Full Stack Developer to join our growing team. You'll be working on cutting-edge web applications using React, Node.js, and modern cloud technologies.",responsibilities:["Design and develop scalable web applications","Collaborate with cross-functional teams","Write clean, maintainable code","Participate in code reviews","Mentor junior developers"],requirements:["3+ years experience with React/Node.js","Strong knowledge of MongoDB/PostgreSQL","Experience with AWS/GCP","Excellent problem-solving skills","Bachelor's degree in Computer Science or related field"],perks:["Remote work options","Health insurance","Learning budget","Flexible hours"]},{id:2,title:"UI/UX Designer",department:"Design",type:"Full-time",location:"Remote",experience:"2-4 years",postedDate:"1 week ago",description:"Create beautiful and intuitive user experiences for our products. Work closely with developers and product managers to bring designs to life.",responsibilities:["Design user interfaces for web and mobile","Create prototypes and wireframes","Conduct user research and testing","Develop design systems","Collaborate with development teams"],requirements:["Proficiency in Figma, Adobe Creative Suite","Portfolio showcasing UI/UX work","Understanding of responsive design","Knowledge of accessibility standards","Excellent communication skills"],perks:["Remote-first","Design tools subscription","Conference budget","Creative freedom"]},{id:3,title:"DevOps Engineer",department:"Operations",type:"Full-time",location:"Nagpur, Maharashtra",experience:"2-3 years",postedDate:"3 days ago",description:"Help us build and maintain our cloud infrastructure. Implement CI/CD pipelines and ensure system reliability.",responsibilities:["Manage AWS/GCP infrastructure","Implement CI/CD pipelines","Monitor system performance","Ensure security best practices","Automate deployment processes"],requirements:["Experience with Docker/Kubernetes","Knowledge of Terraform/CloudFormation","Familiarity with monitoring tools","Understanding of networking concepts","Scripting skills (Bash/Python)"],perks:["Certification support","Latest hardware","On-call compensation","Cloud credits"]},{id:4,title:"Marketing Intern",department:"Marketing",type:"Internship",location:"Nagpur, Maharashtra",experience:"0-1 years",postedDate:"5 days ago",description:"Great opportunity for students to gain real-world marketing experience. Learn digital marketing strategies and content creation.",responsibilities:["Assist with social media campaigns","Create marketing content","Conduct market research","Support email marketing efforts","Analyze campaign performance"],requirements:["Pursuing degree in Marketing/Business","Good communication skills","Basic understanding of digital marketing","Creative mindset","Eagerness to learn"],perks:["Stipend provided","Certificate of completion","Mentorship program","Potential full-time offer"]}],B=[{id:"all",name:"All Roles",count:w.length},{id:"engineering",name:"Engineering",count:2},{id:"design",name:"Design",count:1},{id:"marketing",name:"Marketing",count:1},{id:"operations",name:"Operations",count:1}],k=H=>{p(H),o({...d,position:H.title}),T(!0)},M=H=>{const{name:U,value:L,files:G}=H.target;o(U==="resume"?{...d,resume:G[0]}:{...d,[U]:L})},Q=async H=>{H.preventDefault(),v(!0);try{await new Promise(U=>setTimeout(U,2e3)),alert("Application submitted successfully!"),T(!1),o({fullName:"",email:"",phone:"",position:"",experience:"",resume:null,coverLetter:"",portfolio:"",linkedin:"",referral:"",noticePeriod:"immediate"})}catch(U){alert("Error submitting application. Please try again.",U)}finally{v(!1)}};return i.jsxs("div",{className:"careers-page",children:[i.jsx("section",{className:"careers-hero",children:i.jsxs("div",{className:"hero-container",children:[i.jsxs("div",{className:"hero-content",children:[i.jsxs("h1",{className:"hero-title",children:["Build Your Career at ",i.jsxs("span",{className:"highlight",children:[i.jsx("span",{style:{color:"#E268A0"},children:"RESI"}),"CODE"]})]}),i.jsx("p",{className:"hero-subtitle",children:"Join our team of innovators and problem-solvers. Create impactful solutions that make a difference."}),i.jsxs("div",{className:"hero-stats",children:[i.jsxs("div",{className:"stat-item",children:[i.jsx("div",{className:"stat-number",children:"50+"}),i.jsx("div",{className:"stat-label",children:"Team Members"})]}),i.jsxs("div",{className:"stat-item",children:[i.jsx("div",{className:"stat-number",children:"100+"}),i.jsx("div",{className:"stat-label",children:"Projects Delivered"})]}),i.jsxs("div",{className:"stat-item",children:[i.jsx("div",{className:"stat-number",children:"15+"}),i.jsx("div",{className:"stat-label",children:"Countries Served"})]}),i.jsxs("div",{className:"stat-item",children:[i.jsx("div",{className:"stat-number",children:"4.9"}),i.jsx("div",{className:"stat-label",children:"Client Rating"})]})]})]}),i.jsx("div",{className:"hero-illustration",children:i.jsxs("div",{className:"floating-elements",children:[i.jsx("div",{className:"element element-1",children:"🚀"}),i.jsx("div",{className:"element element-2",children:"💻"}),i.jsx("div",{className:"element element-3",children:"🎯"})]})})]})}),i.jsx("section",{className:"why-join-section",children:i.jsxs("div",{className:"section-container",children:[i.jsxs("div",{className:"section-header",children:[i.jsx("h2",{children:"Why Join Resicode?"}),i.jsx("p",{children:"We believe in creating an environment where talent thrives"})]}),i.jsxs("div",{className:"benefits-grid",children:[i.jsxs("div",{className:"benefit-card",children:[i.jsx("div",{className:"benefit-icon",children:"🌱"}),i.jsx("h3",{children:"Growth & Learning"}),i.jsx("p",{children:"Annual learning budget, certifications, and mentorship programs to help you grow."})]}),i.jsxs("div",{className:"benefit-card",children:[i.jsx("div",{className:"benefit-icon",children:"⚖️"}),i.jsx("h3",{children:"Work-Life Balance"}),i.jsx("p",{children:"Flexible hours, remote options, and generous time off to maintain balance."})]}),i.jsxs("div",{className:"benefit-card",children:[i.jsx("div",{className:"benefit-icon",children:"💼"}),i.jsx("h3",{children:"Career Development"}),i.jsx("p",{children:"Clear growth paths, regular reviews, and opportunities for advancement."})]}),i.jsxs("div",{className:"benefit-card",children:[i.jsx("div",{className:"benefit-icon",children:"🎉"}),i.jsx("h3",{children:"Great Culture"}),i.jsx("p",{children:"Regular team events, celebrations, and a supportive, inclusive environment."})]}),i.jsxs("div",{className:"benefit-card",children:[i.jsx("div",{className:"benefit-icon",children:"💰"}),i.jsx("h3",{children:"Competitive Pay"}),i.jsx("p",{children:"Attractive salary packages with performance bonuses and equity options."})]}),i.jsxs("div",{className:"benefit-card",children:[i.jsx("div",{className:"benefit-icon",children:"🏥"}),i.jsx("h3",{children:"Health & Wellness"}),i.jsx("p",{children:"Health insurance, mental wellness programs, and fitness allowances."})]})]})]})}),i.jsx("section",{className:"openings-section",children:i.jsxs("div",{className:"section-container",children:[i.jsxs("div",{className:"section-header",children:[i.jsx("h2",{children:"Current Openings"}),i.jsx("p",{children:"Find your perfect role in our growing team"})]}),i.jsx("div",{className:"department-tabs",children:B.map(H=>i.jsxs("button",{className:`tab-btn ${s===H.id?"active":""}`,onClick:()=>f(H.id),children:[H.name,i.jsx("span",{className:"job-count",children:H.count})]},H.id))}),i.jsx("div",{className:"job-listings",children:w.map(H=>i.jsxs("div",{className:"job-card",children:[i.jsxs("div",{className:"job-header",children:[i.jsxs("div",{className:"job-title-section",children:[i.jsx("h3",{children:H.title}),i.jsxs("div",{className:"job-meta",children:[i.jsx("span",{className:"job-tag department",children:H.department}),i.jsx("span",{className:"job-tag type",children:H.type}),i.jsxs("span",{className:"job-tag location",children:["📍 ",H.location]})]})]}),i.jsxs("div",{className:"job-experience",children:[i.jsxs("span",{children:["Experience: ",H.experience]}),i.jsxs("span",{className:"posted-date",children:["Posted: ",H.postedDate]})]})]}),i.jsx("p",{className:"job-description",children:H.description}),i.jsx("div",{className:"job-perks",children:H.perks.map((U,L)=>i.jsx("span",{className:"perk-tag",children:U},L))}),i.jsxs("div",{className:"job-actions",children:[i.jsx("button",{className:"view-details-btn",onClick:()=>p(b?.id===H.id?null:H),children:b?.id===H.id?"Hide Details":"View Details"}),i.jsx("button",{className:"apply-now-btn",onClick:()=>k(H),children:"Apply Now"})]}),b?.id===H.id&&i.jsxs("div",{className:"job-details-expanded",children:[i.jsxs("div",{className:"details-section",children:[i.jsx("h4",{children:"Key Responsibilities"}),i.jsx("ul",{children:H.responsibilities.map((U,L)=>i.jsx("li",{children:U},L))})]}),i.jsxs("div",{className:"details-section",children:[i.jsx("h4",{children:"Requirements"}),i.jsx("ul",{children:H.requirements.map((U,L)=>i.jsx("li",{children:U},L))})]})]})]},H.id))})]})}),S&&i.jsx("div",{className:"application-modal",children:i.jsxs("div",{className:"modal-content",children:[i.jsxs("div",{className:"modal-header",children:[i.jsxs("h2",{children:["Apply for ",b?.title]}),i.jsx("button",{className:"close-modal",onClick:()=>T(!1),children:"×"})]}),i.jsxs("form",{onSubmit:Q,className:"application-form",children:[i.jsxs("div",{className:"form-grid",children:[i.jsxs("div",{className:"form-group",children:[i.jsx("label",{htmlFor:"fullName",children:"Full Name *"}),i.jsx("input",{type:"text",id:"fullName",name:"fullName",value:d.fullName,onChange:M,required:!0,placeholder:"John Doe"})]}),i.jsxs("div",{className:"form-group",children:[i.jsx("label",{htmlFor:"email",children:"Email Address *"}),i.jsx("input",{type:"email",id:"email",name:"email",value:d.email,onChange:M,required:!0,placeholder:"john@example.com"})]}),i.jsxs("div",{className:"form-group",children:[i.jsx("label",{htmlFor:"phone",children:"Phone Number *"}),i.jsx("input",{type:"tel",id:"phone",name:"phone",value:d.phone,onChange:M,required:!0,placeholder:"+91 9876543210"})]}),i.jsxs("div",{className:"form-group",children:[i.jsx("label",{htmlFor:"experience",children:"Years of Experience *"}),i.jsxs("select",{id:"experience",name:"experience",value:d.experience,onChange:M,required:!0,children:[i.jsx("option",{value:"",children:"Select experience"}),i.jsx("option",{value:"0-1",children:"0-1 years"}),i.jsx("option",{value:"1-3",children:"1-3 years"}),i.jsx("option",{value:"3-5",children:"3-5 years"}),i.jsx("option",{value:"5+",children:"5+ years"})]})]}),i.jsxs("div",{className:"form-group full-width",children:[i.jsx("label",{htmlFor:"coverLetter",children:"Cover Letter"}),i.jsx("textarea",{id:"coverLetter",name:"coverLetter",value:d.coverLetter,onChange:M,rows:"4",placeholder:"Tell us why you're interested in this position..."})]}),i.jsxs("div",{className:"form-group",children:[i.jsx("label",{htmlFor:"resume",children:"Resume/CV *"}),i.jsx("input",{type:"file",id:"resume",name:"resume",onChange:M,accept:".pdf,.doc,.docx",required:!0}),i.jsx("small",{children:"PDF, DOC, DOCX (Max 5MB)"})]}),i.jsxs("div",{className:"form-group",children:[i.jsx("label",{htmlFor:"portfolio",children:"Portfolio/GitHub Link"}),i.jsx("input",{type:"url",id:"portfolio",name:"portfolio",value:d.portfolio,onChange:M,placeholder:"https://github.com/username"})]}),i.jsxs("div",{className:"form-group",children:[i.jsx("label",{htmlFor:"linkedin",children:"LinkedIn Profile"}),i.jsx("input",{type:"url",id:"linkedin",name:"linkedin",value:d.linkedin,onChange:M,placeholder:"https://linkedin.com/in/username"})]}),i.jsxs("div",{className:"form-group",children:[i.jsx("label",{htmlFor:"noticePeriod",children:"Notice Period"}),i.jsxs("select",{id:"noticePeriod",name:"noticePeriod",value:d.noticePeriod,onChange:M,children:[i.jsx("option",{value:"immediate",children:"Immediate"}),i.jsx("option",{value:"15",children:"15 days"}),i.jsx("option",{value:"30",children:"30 days"}),i.jsx("option",{value:"60",children:"60 days"}),i.jsx("option",{value:"90",children:"90 days"})]})]}),i.jsxs("div",{className:"form-group full-width",children:[i.jsx("label",{htmlFor:"referral",children:"How did you hear about us?"}),i.jsx("input",{type:"text",id:"referral",name:"referral",value:d.referral,onChange:M,placeholder:"LinkedIn, Indeed, Referral, etc."})]})]}),i.jsxs("div",{className:"form-actions",children:[i.jsx("button",{type:"button",className:"cancel-btn",onClick:()=>T(!1),children:"Cancel"}),i.jsx("button",{type:"submit",className:"submit-application-btn",disabled:m,children:m?"Submitting...":"Submit Application"})]})]})]})}),i.jsx("section",{className:"process-section",children:i.jsxs("div",{className:"section-container",children:[i.jsxs("div",{className:"section-header",children:[i.jsx("h2",{children:"Our Hiring Process"}),i.jsx("p",{children:"Simple, transparent, and respectful"})]}),i.jsxs("div",{className:"process-steps",children:[i.jsxs("div",{className:"step",children:[i.jsx("div",{className:"step-number",children:"1"}),i.jsx("h3",{children:"Application Review"}),i.jsx("p",{children:"We review your application within 48 hours"})]}),i.jsxs("div",{className:"step",children:[i.jsx("div",{className:"step-number",children:"2"}),i.jsx("h3",{children:"Initial Screening"}),i.jsx("p",{children:"30-minute call with HR to discuss fit"})]}),i.jsxs("div",{className:"step",children:[i.jsx("div",{className:"step-number",children:"3"}),i.jsx("h3",{children:"Technical Assessment"}),i.jsx("p",{children:"Practical assignment or technical interview"})]}),i.jsxs("div",{className:"step",children:[i.jsx("div",{className:"step-number",children:"4"}),i.jsx("h3",{children:"Team Interview"}),i.jsx("p",{children:"Meet with team leads and potential colleagues"})]}),i.jsxs("div",{className:"step",children:[i.jsx("div",{className:"step-number",children:"5"}),i.jsx("h3",{children:"Offer & Onboarding"}),i.jsx("p",{children:"Offer letter and smooth onboarding process"})]})]})]})}),i.jsx("section",{className:"cta-section",children:i.jsx("div",{className:"section-container",children:i.jsxs("div",{className:"cta-content",children:[i.jsx("h2",{children:"Don't See Your Role?"}),i.jsx("p",{children:"We're always looking for talented individuals. Send us your resume and we'll keep you in mind for future opportunities."}),i.jsx("button",{className:"general-application-btn",children:"Submit General Application"})]})})}),i.jsx("style",{jsx:!0,children:`
      ...
      `})]})},bg=()=>i.jsx(px,{children:i.jsxs("div",{className:"min-h-screen flex flex-col",children:[i.jsx(zx,{}),i.jsx("main",{className:"flex-grow",children:i.jsxs(Zp,{children:[i.jsx(Ga,{path:"/",element:i.jsxs(i.Fragment,{children:[i.jsx(Ax,{}),i.jsx(Mx,{}),i.jsx(dg,{}),i.jsx(fg,{}),i.jsx(hg,{})]})}),i.jsx(Ga,{path:"/about",element:i.jsx(lg,{})}),i.jsx(Ga,{path:"/services",element:i.jsx(cg,{})}),i.jsx(Ga,{path:"/team",element:i.jsx(gg,{})}),i.jsx(Ga,{path:"/contact",element:i.jsx(og,{})}),i.jsx(Ga,{path:"/careers",element:i.jsx(vg,{})})]})}),i.jsx(Px,{})]})});tp.createRoot(document.getElementById("root")).render(i.jsx(A.StrictMode,{children:i.jsx(bg,{})}));
