(function(){const f=document.createElement("link").relList;if(f&&f.supports&&f.supports("modulepreload"))return;for(const h of document.querySelectorAll('link[rel="modulepreload"]'))o(h);new MutationObserver(h=>{for(const x of h)if(x.type==="childList")for(const S of x.addedNodes)S.tagName==="LINK"&&S.rel==="modulepreload"&&o(S)}).observe(document,{childList:!0,subtree:!0});function d(h){const x={};return h.integrity&&(x.integrity=h.integrity),h.referrerPolicy&&(x.referrerPolicy=h.referrerPolicy),h.crossOrigin==="use-credentials"?x.credentials="include":h.crossOrigin==="anonymous"?x.credentials="omit":x.credentials="same-origin",x}function o(h){if(h.ep)return;h.ep=!0;const x=d(h);fetch(h.href,x)}})();function V0(s){return s&&s.__esModule&&Object.prototype.hasOwnProperty.call(s,"default")?s.default:s}var Nc={exports:{}},Rn={};/**
 * @license React
 ...
 */var Mf;function Z0(){if(Mf)return Rn;Mf=1;var s=Symbol.for("react.transitional.element"),f=Symbol.for("react.fragment");function d(o,h,x){var S=null;if(x!==void 0&&(S=""+x),h.key!==void 0&&(S=""+h.key),"key"in h){x={};for(var T in h)T!=="key"&&(x[T]=h[T])}else x=h;return h=x.ref,{$$typeof:s,type:o,key:S,ref:h!==void 0?h:null,props:x}}return Rn.Fragment=f,Rn.jsx=d,Rn.jsxs=d,Rn}var Cf;function K0(){return Cf||(Cf=1,Nc.exports=Z0()),Nc.exports}var i=K0(),wc={exports:{}},te={};/**
 * @license React
 * react.production.js
 *
 * Copyright (c) Meta Platforms, Inc. and affiliates.
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var _f;function J0(){if(_f)return te;_f=1;var s=Symbol.for("react.transitional.element"),f=Symbol.for("react.portal"),d=Symbol.for("react.fragment"),o=Symbol.for("react.strict_mode"),h=Symbol.for("react.profiler"),x=Symbol.for("react.consumer"),S=Symbol.for("react.context"),T=Symbol.for("react.forward_ref"),b=Symbol.for("react.suspense"),p=Symbol.for("react.memo"),w=Symbol.for("react.lazy"),B=Symbol.iterator;function k(g){return g===null||typeof g!="object"?null:(g=B&&g[B]||g["@@iterator"],typeof g=="function"?g:null)}var M={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},Q=Object.assign,U={};function H(g,_,G){this.props=g,this.context=_,this.refs=U,this.updater=G||M}H.prototype.isReactComponent={},H.prototype.setState=function(g,_){if(typeof g!="object"&&typeof g!="function"&&g!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,g,_,"setState")},H.prototype.forceUpdate=function(g){this.updater.enqueueForceUpdate(this,g,"forceUpdate")};function Y(){}Y.prototype=H.prototype;function X(g,_,G){this.props=g,this.context=_,this.refs=U,this.updater=G||M}var ee=X.prototype=new Y;ee.constructor=X,Q(ee,H.prototype),ee.isPureReactComponent=!0;var ye=Array.isArray,P={H:null,A:null,T:null,S:null,V:null},_e=Object.prototype.hasOwnProperty;function Re(g,_,G,L,K,se){return G=se.ref,{$$typeof:s,type:g,key:_,ref:G!==void 0?G:null,props:se}}function Ue(g,_){return Re(g.type,_,void 0,void 0,void 0,g.props)}function we(g){return typeof g=="object"&&g!==null&&g.$$typeof===s}function et(g){var _={"=":"=0",":":"=2"};return"$"+g.replace(/[=:]/g,function(G){return _[G]})}var dt=/\/+/g;function Xe(g,_){return typeof g=="object"&&g!==null&&g.key!=null?et(""+g.key):_.toString(36)}function Na(){}function wa(g){switch(g.status){case"fulfilled":return g.value;case"rejected":throw g.reason;default:switch(typeof g.status=="string"?g.then(Na,Na):(g.status="pending",g.then(function(_){g.status==="pending"&&(g.status="fulfilled",g.value=_)},function(_){g.status==="pending"&&(g.status="rejected",g.reason=_)})),g.status){case"fulfilled":return g.value;case"rejected":throw g.reason}}throw g}function Qe(g,_,G,L,K){var se=typeof g;(se==="undefined"||se==="boolean")&&(g=null);var I=!1;if(g===null)I=!0;else switch(se){case"bigint":case"string":case"number":I=!0;break;case"object":switch(g.$$typeof){case s:case f:I=!0;break;case w:return I=g._init,Qe(I(g._payload),_,G,L,K)}}if(I)return K=K(g),I=L===""?"."+Xe(g,0):L,ye(K)?(G="",I!=null&&(G=I.replace(dt,"$&/")+"/"),Qe(K,_,G,"",function($t){return $t})):K!=null&&(we(K)&&(K=Ue(K,G+(K.key==null||g&&g.key===K.key?"":(""+K.key).replace(dt,"$&/")+"/")+I)),_.push(K)),1;I=0;var tt=L===""?".":L+":";if(ye(g))for(var ve=0;ve<g.length;ve++)L=g[ve],se=tt+Xe(L,ve),I+=Qe(L,_,G,se,K);else if(ve=k(g),typeof ve=="function")for(g=ve.call(g),ve=0;!(L=g.next()).done;)L=L.value,se=tt+Xe(L,ve++),I+=Qe(L,_,G,se,K);else if(se==="object"){if(typeof g.then=="function")return Qe(wa(g),_,G,L,K);throw _=String(g),Error("Objects are not valid as a React child (found: "+(_==="[object Object]"?"object with keys {"+Object.keys(g).join(", ")+"}":_)+"). If you meant to render a collection of children, use an array instead.")}return I}function R(g,_,G){if(g==null)return g;var L=[],K=0;return Qe(g,L,"","",function(se){return _.call(G,se,K++)}),L}function q(g){if(g._status===-1){var _=g._result;_=_(),_.then(function(G){(g._status===0||g._status===-1)&&(g._status=1,g._result=G)},function(G){(g._status===0||g._status===-1)&&(g._status=2,g._result=G)}),g._status===-1&&(g._status=0,g._result=_)}if(g._status===1)return g._result.default;throw g._result}var W=typeof reportError=="function"?reportError:function(g){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var _=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof g=="object"&&g!==null&&typeof g.message=="string"?String(g.message):String(g),error:g});if(!window.dispatchEvent(_))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",g);return}console.error(g)};function pe(){}return te.Children={map:R,forEach:function(g,_,G){R(g,function(){_.apply(this,arguments)},G)},count:function(g){var _=0;return R(g,function(){_++}),_},toArray:function(g){return R(g,function(_){return _})||[]},only:function(g){if(!we(g))throw Error("React.Children.only expected to receive a single React element child.");return g}},te.Component=H,te.Fragment=d,te.Profiler=h,te.PureComponent=X,te.StrictMode=o,te.Suspense=b,te.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=P,te.__COMPILER_RUNTIME={__proto__:null,c:function(g){return P.H.useMemoCache(g)}},te.cache=function(g){return function(){return g.apply(null,arguments)}},te.cloneElement=function(g,_,G){if(g==null)throw Error("The argument must be a React element, but you passed "+g+".");var L=Q({},g.props),K=g.key,se=void 0;if(_!=null)for(I in _.ref!==void 0&&(se=void 0),_.key!==void 0&&(K=""+_.key),_)!_e.call(_,I)||I==="key"||I==="__self"||I==="__source"||I==="ref"&&_.ref===void 0||(L[I]=_[I]);var I=arguments.length-2;if(I===1)L.children=G;else if(1<I){for(var tt=Array(I),ve=0;ve<I;ve++)tt[ve]=arguments[ve+2];L.children=tt}return Re(g.type,K,void 0,void 0,se,L)},te.createContext=function(g){return g={$$typeof:S,_currentValue:g,_currentValue2:g,_threadCount:0,Provider:null,Consumer:null},g.Provider=g,g.Consumer={$$typeof:x,_context:g},g},te.createElement=function(g,_,G){var L,K={},se=null;if(_!=null)for(L in _.key!==void 0&&(se=""+_.key),_)_e.call(_,L)&&L!=="key"&&L!=="__self"&&L!=="__source"&&(K[L]=_[L]);var I=arguments.length-2;if(I===1)K.children=G;else if(1<I){for(var tt=Array(I),ve=0;ve<I;ve++)tt[ve]=arguments[ve+2];K.children=tt}if(g&&g.defaultProps)for(L in I=g.defaultProps,I)K[L]===void 0&&(K[L]=I[L]);return Re(g,se,void 0,void 0,null,K)},te.createRef=function(){return{current:null}},te.forwardRef=function(g){return{$$typeof:T,render:g}},te.isValidElement=we,te.lazy=function(g){return{$$typeof:w,_payload:{_status:-1,_result:g},_init:q}},te.memo=function(g,_){return{$$typeof:p,type:g,compare:_===void 0?null:_}},te.startTransition=function(g){var _=P.T,G={};P.T=G;try{var L=g(),K=P.S;K!==null&&K(G,L),typeof L=="object"&&L!==null&&typeof L.then=="function"&&L.then(pe,W)}catch(se){W(se)}finally{P.T=_}},te.unstable_useCacheRefresh=function(){return P.H.useCacheRefresh()},te.use=function(g){return P.H.use(g)},te.useActionState=function(g,_,G){return P.H.useActionState(g,_,G)},te.useCallback=function(g,_){return P.H.useCallback(g,_)},te.useContext=function(g){return P.H.useContext(g)},te.useDebugValue=function(){},te.useDeferredValue=function(g,_){return P.H.useDeferredValue(g,_)},te.useEffect=function(g,_,G){var L=P.H;if(typeof G=="function")throw Error("useEffect CRUD overload is not enabled in this build of React.");return L.useEffect(g,_)},te.useId=function(){return P.H.useId()},te.useImperativeHandle=function(g,_,G){return P.H.useImperativeHandle(g,_,G)},te.useInsertionEffect=function(g,_){return P.H.useInsertionEffect(g,_)},te.useLayoutEffect=function(g,_){return P.H.useLayoutEffect(g,_)},te.useMemo=function(g,_){return P.H.useMemo(g,_)},te.useOptimistic=function(g,_){return P.H.useOptimistic(g,_)},te.useReducer=function(g,_,G){return P.H.useReducer(g,_,G)},te.useRef=function(g){return P.H.useRef(g)},te.useState=function(g){return P.H.useState(g)},te.useSyncExternalStore=function(g,_,G){return P.H.useSyncExternalStore(g,_,G)},te.useTransition=function(){return P.H.useTransition()},te.version="19.1.1",te}var Uf;function Mc(){return Uf||(Uf=1,wc.exports=J0()),wc.exports}var A=Mc();const Qa=V0(A);var Sc={exports:{}},On={},Ec={exports:{}},zc={};/**
 * @license React
...
`),N=u.split(`
`);for(n=l=0;l<m.length&&!m[l].includes("DetermineComponentFrameRoot");)l++;for(;n<N.length&&!N[n].includes("DetermineComponentFrameRoot");)n++;if(l===m.length||n===N.length)for(l=m.length-1,n=N.length-1;1<=l&&0<=n&&m[l]!==N[n];)n--;for(;1<=l&&0<=n;l--,n--)if(m[l]!==N[n]){if(l!==1||n!==1)do if(l--,n--,0>n||m[l]!==N[n]){var D=`
 ...
 *
 * @license MIT
 */var Gf="popstate";function ap(s={}){function f(o,h){let{pathname:x,search:S,hash:T}=o.location;return Rc("",{pathname:x,search:S,hash:T},h.state&&h.state.usr||null,h.state&&h.state.key||"default")}function d(o,h){return typeof h=="string"?h:_n(h)}return np(f,d,null,s)}function Ne(s,f){if(s===!1||s===null||typeof s>"u")throw new Error(f)}function Rt(s,f){if(!s){typeof console<"u"&&console.warn(f);try{throw new Error(f)}catch{}}}function lp(){return Math.random().toString(36).substring(2,10)}function Xf(s,f){return{usr:s.state,key:s.key,idx:f}}function Rc(s,f,d=null,o){return{pathname:typeof s=="string"?s:s.pathname,search:"",hash:"",...typeof f=="string"?Rl(f):f,state:d,key:f&&f.key||o||lp()}}function _n({pathname:s="/",search:f="",hash:d=""}){return f&&f!=="?"&&(s+=f.charAt(0)==="?"?f:"?"+f),d&&d!=="#"&&(s+=d.charAt(0)==="#"?d:"#"+d),s}function Rl(s){let f={};if(s){let d=s.indexOf("#");d>=0&&(f.hash=s.substring(d),s=s.substring(0,d));let o=s.indexOf("?");o>=0&&(f.search=s.substring(o),s=s.substring(0,o)),s&&(f.pathname=s)}return f}function np(s,f,d,o={}){let{window:h=document.defaultView,v5Compat:x=!1}=o,S=h.history,T="POP",b=null,p=w();p==null&&(p=0,S.replaceState({...S.state,idx:p},""));function w(){return(S.state||{idx:null}).idx}function B(){T="POP";let H=w(),Y=H==null?null:H-p;p=H,b&&b({action:T,location:U.location,delta:Y})}function k(H,Y){T="PUSH";let X=Rc(U.location,H,Y);p=w()+1;let ee=Xf(X,p),ye=U.createHref(X);try{S.pushState(ee,"",ye)}catch(P){if(P instanceof DOMException&&P.name==="DataCloneError")throw P;h.location.assign(ye)}x&&b&&b({action:T,location:U.location,delta:1})}function M(H,Y){T="REPLACE";let X=Rc(U.location,H,Y);p=w();let ee=Xf(X,p),ye=U.createHref(X);S.replaceState(ee,"",ye),x&&b&&b({action:T,location:U.location,delta:0})}function Q(H){return ip(H)}let U={get action(){return T},get location(){return s(h,S)},listen(H){if(b)throw new Error("A history only accepts one active listener");return h.addEventListener(Gf,B),b=H,()=>{h.removeEventListener(Gf,B),b=null}},createHref(H){return f(h,H)},createURL:Q,encodeLocation(H){let Y=Q(H);return{pathname:Y.pathname,search:Y.search,hash:Y.hash}},push:k,replace:M,go(H){return S.go(H)}};return U}function ip(s,f=!1){let d="http://localhost";typeof window<"u"&&(d=window.location.origin!=="null"?window.location.origin:window.location.href),Ne(d,"No window.location.(origin|href) available to create URL");let o=typeof s=="string"?s:_n(s);return o=o.replace(/ $/,"%20"),!f&&o.startsWith("//")&&(o=d+o),new URL(o,d)}function em(s,f,d="/"){return rp(s,f,d,!1)}function rp(s,f,d,o){let h=typeof f=="string"?Rl(f):f,x=Jt(h.pathname||"/",d);if(x==null)return null;let S=tm(s);sp(S);let T=null;for(let b=0;T==null&&b<S.length;++b){let p=vp(x);T=xp(S[b],p,o)}return T}function tm(s,f=[],d=[],o="",h=!1){let x=(S,T,b=h,p)=>{let w={relativePath:p===void 0?S.path||"":p,caseSensitive:S.caseSensitive===!0,childrenIndex:T,route:S};if(w.relativePath.startsWith("/")){if(!w.relativePath.startsWith(o)&&b)return;Ne(w.relativePath.startsWith(o),`Absolute route path "${w.relativePath}" nested under path "${o}" is not valid. An absolute child route path must start with the combined path of all its parent routes.`),w.relativePath=w.relativePath.slice(o.length)}let B=Kt([o,w.relativePath]),k=d.concat(w);S.children&&S.children.length>0&&(Ne(S.index!==!0,`Index routes must not have child routes. Please remove all child routes from route path "${B}".`),tm(S.children,f,k,B,b)),!(S.path==null&&!S.index)&&f.push({path:B,score:hp(B,S.index),routesMeta:k})};return s.forEach((S,T)=>{if(S.path===""||!S.path?.includes("?"))x(S,T);else for(let b of am(S.path))x(S,T,!0,b)}),f}function am(s){let f=s.split("/");if(f.length===0)return[];let[d,...o]=f,h=d.endsWith("?"),x=d.replace(/\?$/,"");if(o.length===0)return h?[x,""]:[x];let S=am(o.join("/")),T=[];return T.push(...S.map(b=>b===""?x:[x,b].join("/"))),h&&T.push(...S),T.map(b=>s.startsWith("/")&&b===""?"/":b)}function sp(s){s.sort((f,d)=>f.score!==d.score?d.score-f.score:pp(f.routesMeta.map(o=>o.childrenIndex),d.routesMeta.map(o=>o.childrenIndex)))}var cp=/^:[\w-]+$/,op=3,up=2,dp=1,fp=10,mp=-2,Qf=s=>s==="*";function hp(s,f){let d=s.split("/"),o=d.length;return d.some(Qf)&&(o+=mp),f&&(o+=up),d.filter(h=>!Qf(h)).reduce((h,x)=>h+(cp.test(x)?op:x===""?dp:fp),o)}function pp(s,f){return s.length===f.length&&s.slice(0,-1).every((o,h)=>o===f[h])?s[s.length-1]-f[f.length-1]:0}function xp(s,f,d=!1){let{routesMeta:o}=s,h={},x="/",S=[];for(let T=0;T<o.length;++T){let b=o[T],p=T===o.length-1,w=x==="/"?f:f.slice(x.length)||"/",B=ar({path:b.relativePath,caseSensitive:b.caseSensitive,end:p},w),k=b.route;if(!B&&p&&d&&!o[o.length-1].route.index&&(B=ar({path:b.relativePath,caseSensitive:b.caseSensitive,end:!1},w)),!B)return null;Object.assign(h,B.params),S.push({params:h,pathname:Kt([x,B.pathname]),pathnameBase:Np(Kt([x,B.pathnameBase])),route:k}),B.pathnameBase!=="/"&&(x=Kt([x,B.pathnameBase]))}return S}function ar(s,f){typeof s=="string"&&(s={path:s,caseSensitive:!1,end:!0});let[d,o]=gp(s.path,s.caseSensitive,s.end),h=f.match(d);if(!h)return null;let x=h[0],S=x.replace(/(.)\/+$/,"$1"),T=h.slice(1);return{params:o.reduce((p,{paramName:w,isOptional:B},k)=>{if(w==="*"){let Q=T[k]||"";S=x.slice(0,x.length-Q.length).replace(/(.)\/+$/,"$1")}const M=T[k];return B&&!M?p[w]=void 0:p[w]=(M||"").replace(/%2F/g,"/"),p},{}),pathname:x,pathnameBase:S,pattern:s}}function gp(s,f=!1,d=!0){Rt(s==="*"||!s.endsWith("*")||s.endsWith("/*"),`Route path "${s}" will be treated as if it were "${s.replace(/\*$/,"/*")}" because the \`*\` character must always follow a \`/\` in the pattern. To get rid of this warning, please change the route path to "${s.replace(/\*$/,"/*")}".`);let o=[],h="^"+s.replace(/\/*\*?$/,"").replace(/^\/*/,"/").replace(/[\\.*+^${}|()[\]]/g,"\\$&").replace(/\/:([\w-]+)(\?)?/g,(S,T,b)=>(o.push({paramName:T,isOptional:b!=null}),b?"/?([^\\/]+)?":"/([^\\/]+)")).replace(/\/([\w-]+)\?(\/|$)/g,"(/$1)?$2");return s.endsWith("*")?(o.push({paramName:"*"}),h+=s==="*"||s==="/*"?"(.*)$":"(?:\\/(.+)|\\/*)$"):d?h+="\\/*$":s!==""&&s!=="/"&&(h+="(?:(?=\\/|$))"),[new RegExp(h,f?void 0:"i"),o]}function vp(s){try{return s.split("/").map(f=>decodeURIComponent(f).replace(/\//g,"%2F")).join("/")}catch(f){return Rt(!1,`The URL path "${s}" could not be decoded because it is a malformed URL segment. This is probably due to a bad percent encoding (${f}).`),s}}function Jt(s,f){if(f==="/")return s;if(!s.toLowerCase().startsWith(f.toLowerCase()))return null;let d=f.endsWith("/")?f.length-1:f.length,o=s.charAt(d);return o&&o!=="/"?null:s.slice(d)||"/"}function bp(s,f="/"){let{pathname:d,search:o="",hash:h=""}=typeof s=="string"?Rl(s):s;return{pathname:d?d.startsWith("/")?d:yp(d,f):f,search:wp(o),hash:Sp(h)}}function yp(s,f){let d=f.replace(/\/+$/,"").split("/");return s.split("/").forEach(h=>{h===".."?d.length>1&&d.pop():h!=="."&&d.push(h)}),d.length>1?d.join("/"):"/"}function Ac(s,f,d,o){return`Cannot include a '${s}' character in a manually specified \`to.${f}\` field [${JSON.stringify(o)}].  Please separate it out to the \`to.${d}\` field. Alternatively you may provide the full path as a string in <Link to="..."> and the router will parse it for you.`}function jp(s){return s.filter((f,d)=>d===0||f.route.path&&f.route.path.length>0)}function lm(s){let f=jp(s);return f.map((d,o)=>o===f.length-1?d.pathname:d.pathnameBase)}function nm(s,f,d,o=!1){let h;typeof s=="string"?h=Rl(s):(h={...s},Ne(!h.pathname||!h.pathname.includes("?"),Ac("?","pathname","search",h)),Ne(!h.pathname||!h.pathname.includes("#"),Ac("#","pathname","hash",h)),Ne(!h.search||!h.search.includes("#"),Ac("#","search","hash",h)));let x=s===""||h.pathname==="",S=x?"/":h.pathname,T;if(S==null)T=d;else{let B=f.length-1;if(!o&&S.startsWith("..")){let k=S.split("/");for(;k[0]==="..";)k.shift(),B-=1;h.pathname=k.join("/")}T=B>=0?f[B]:"/"}let b=bp(h,T),p=S&&S!=="/"&&S.endsWith("/"),w=(x||S===".")&&d.endsWith("/");return!b.pathname.endsWith("/")&&(p||w)&&(b.pathname+="/"),b}var Kt=s=>s.join("/").replace(/\/\/+/g,"/"),Np=s=>s.replace(/\/+$/,"").replace(/^\/*/,"/"),wp=s=>!s||s==="?"?"":s.startsWith("?")?s:"?"+s,Sp=s=>!s||s==="#"?"":s.startsWith("#")?s:"#"+s;function Ep(s){return s!=null&&typeof s.status=="number"&&typeof s.statusText=="string"&&typeof s.internal=="boolean"&&"data"in s}var im=["POST","PUT","PATCH","DELETE"];new Set(im);var zp=["GET",...im];new Set(zp);var Ol=A.createContext(null);Ol.displayName="DataRouter";var ir=A.createContext(null);ir.displayName="DataRouterState";A.createContext(!1);var rm=A.createContext({isTransitioning:!1});rm.displayName="ViewTransition";var Tp=A.createContext(new Map);Tp.displayName="Fetchers";var Ap=A.createContext(null);Ap.displayName="Await";var Ot=A.createContext(null);Ot.displayName="Navigation";var Un=A.createContext(null);Un.displayName="Location";var Ft=A.createContext({outlet:null,matches:[],isDataRoute:!1});Ft.displayName="Route";var Cc=A.createContext(null);Cc.displayName="RouteError";function Dp(s,{relative:f}={}){Ne(Bn(),"useHref() may be used only in the context of a <Router> component.");let{basename:d,navigator:o}=A.useContext(Ot),{hash:h,pathname:x,search:S}=Hn(s,{relative:f}),T=x;return d!=="/"&&(T=x==="/"?d:Kt([d,x])),o.createHref({pathname:T,search:S,hash:h})}function Bn(){return A.useContext(Un)!=null}function Wt(){return Ne(Bn(),"useLocation() may be used only in the context of a <Router> component."),A.useContext(Un).location}var sm="You should call navigate() in a React.useEffect(), not when your component is first rendered.";function cm(s){A.useContext(Ot).static||A.useLayoutEffect(s)}function Rp(){let{isDataRoute:s}=A.useContext(Ft);return s?Xp():Op()}function Op(){Ne(Bn(),"useNavigate() may be used only in the context of a <Router> component.");let s=A.useContext(Ol),{basename:f,navigator:d}=A.useContext(Ot),{matches:o}=A.useContext(Ft),{pathname:h}=Wt(),x=JSON.stringify(lm(o)),S=A.useRef(!1);return cm(()=>{S.current=!0}),A.useCallback((b,p={})=>{if(Rt(S.current,sm),!S.current)return;if(typeof b=="number"){d.go(b);return}let w=nm(b,JSON.parse(x),h,p.relative==="path");s==null&&f!=="/"&&(w.pathname=w.pathname==="/"?f:Kt([f,w.pathname])),(p.replace?d.replace:d.push)(w,p.state,p)},[f,d,x,h,s])}A.createContext(null);function Hn(s,{relative:f}={}){let{matches:d}=A.useContext(Ft),{pathname:o}=Wt(),h=JSON.stringify(lm(d));return A.useMemo(()=>nm(s,JSON.parse(h),o,f==="path"),[s,h,o,f])}function Mp(s,f){return om(s,f)}function om(s,f,d,o,h){Ne(Bn(),"useRoutes() may be used only in the context of a <Router> component.");let{navigator:x}=A.useContext(Ot),{matches:S}=A.useContext(Ft),T=S[S.length-1],b=T?T.params:{},p=T?T.pathname:"/",w=T?T.pathnameBase:"/",B=T&&T.route;{let X=B&&B.path||"";um(p,!B||X.endsWith("*")||X.endsWith("*?"),`You rendered descendant <Routes> (or called \`useRoutes()\`) at "${p}" (under <Route path="${X}">) but the parent route path has no trailing "*". This means if you navigate deeper, the parent won't match anymore and therefore the child routes will never render.

Please change the parent <Route path="${X}"> to <Route path="${X==="/"?"*":`${X}/*`}">.`)}let k=Wt(),M;if(f){let X=typeof f=="string"?Rl(f):f;Ne(w==="/"||X.pathname?.startsWith(w),`When overriding the location using \`<Routes location>\` or \`useRoutes(routes, location)\`, the location pathname must begin with the portion of the URL pathname that was matched by all parent routes. The current pathname base is "${w}" but pathname "${X.pathname}" was given in the \`location\` prop.`),M=X}else M=k;let Q=M.pathname||"/",U=Q;if(w!=="/"){let X=w.replace(/^\//,"").split("/");U="/"+Q.replace(/^\//,"").split("/").slice(X.length).join("/")}let H=em(s,{pathname:U});Rt(B||H!=null,`No routes matched location "${M.pathname}${M.search}${M.hash}" `),Rt(H==null||H[H.length-1].route.element!==void 0||H[H.length-1].route.Component!==void 0||H[H.length-1].route.lazy!==void 0,`Matched leaf route at location "${M.pathname}${M.search}${M.hash}" does not have an element or Component. This means it will render an <Outlet /> with a null value by default resulting in an "empty" page.`);let Y=Hp(H&&H.map(X=>Object.assign({},X,{params:Object.assign({},b,X.params),pathname:Kt([w,x.encodeLocation?x.encodeLocation(X.pathname).pathname:X.pathname]),pathnameBase:X.pathnameBase==="/"?w:Kt([w,x.encodeLocation?x.encodeLocation(X.pathnameBase).pathname:X.pathnameBase])})),S,d,o,h);return f&&Y?A.createElement(Un.Provider,{value:{location:{pathname:"/",search:"",hash:"",state:null,key:"default",...M},navigationType:"POP"}},Y):Y}function Cp(){let s=Gp(),f=Ep(s)?`${s.status} ${s.statusText}`:s instanceof Error?s.message:JSON.stringify(s),d=s instanceof Error?s.stack:null,o="rgba(200,200,200, 0.5)",h={padding:"0.5rem",backgroundColor:o},x={padding:"2px 4px",backgroundColor:o},S=null;return console.error("Error handled by React Router default ErrorBoundary:",s),S=A.createElement(A.Fragment,null,A.createElement("p",null,"💿 Hey developer 👋"),A.createElement("p",null,"You can provide a way better UX than this when your app throws errors by providing your own ",A.createElement("code",{style:x},"ErrorBoundary")," or"," ",A.createElement("code",{style:x},"errorElement")," prop on your route.")),A.createElement(A.Fragment,null,A.createElement("h2",null,"Unexpected Application Error!"),A.createElement("h3",{style:{fontStyle:"italic"}},f),d?A.createElement("pre",{style:h},d):null,S)}var _p=A.createElement(Cp,null),Up=class extends A.Component{constructor(s){super(s),this.state={location:s.location,revalidation:s.revalidation,error:s.error}}static getDerivedStateFromError(s){return{error:s}}static getDerivedStateFromProps(s,f){return f.location!==s.location||f.revalidation!=="idle"&&s.revalidation==="idle"?{error:s.error,location:s.location,revalidation:s.revalidation}:{error:s.error!==void 0?s.error:f.error,location:f.location,revalidation:s.revalidation||f.revalidation}}componentDidCatch(s,f){this.props.unstable_onError?this.props.unstable_onError(s,f):console.error("React Router caught the following error during render",s)}render(){return this.state.error!==void 0?A.createElement(Ft.Provider,{value:this.props.routeContext},A.createElement(Cc.Provider,{value:this.state.error,children:this.props.component})):this.props.children}};function Bp({routeContext:s,match:f,children:d}){let o=A.useContext(Ol);return o&&o.static&&o.staticContext&&(f.route.errorElement||f.route.ErrorBoundary)&&(o.staticContext._deepestRenderedBoundaryId=f.route.id),A.createElement(Ft.Provider,{value:s},d)}function Hp(s,f=[],d=null,o=null,h=null){if(s==null){if(!d)return null;if(d.errors)s=d.matches;else if(f.length===0&&!d.initialized&&d.matches.length>0)s=d.matches;else return null}let x=s,S=d?.errors;if(S!=null){let p=x.findIndex(w=>w.route.id&&S?.[w.route.id]!==void 0);Ne(p>=0,`Could not find a matching route for errors on route IDs: ${Object.keys(S).join(",")}`),x=x.slice(0,Math.min(x.length,p+1))}let T=!1,b=-1;if(d)for(let p=0;p<x.length;p++){let w=x[p];if((w.route.HydrateFallback||w.route.hydrateFallbackElement)&&(b=p),w.route.id){let{loaderData:B,errors:k}=d,M=w.route.loader&&!B.hasOwnProperty(w.route.id)&&(!k||k[w.route.id]===void 0);if(w.route.lazy||M){T=!0,b>=0?x=x.slice(0,b+1):x=[x[0]];break}}}return x.reduceRight((p,w,B)=>{let k,M=!1,Q=null,U=null;d&&(k=S&&w.route.id?S[w.route.id]:void 0,Q=w.route.errorElement||_p,T&&(b<0&&B===0?(um("route-fallback",!1,"No `HydrateFallback` element provided to render during initial hydration"),M=!0,U=null):b===B&&(M=!0,U=w.route.hydrateFallbackElement||null)));let H=f.concat(x.slice(0,B+1)),Y=()=>{let X;return k?X=Q:M?X=U:w.route.Component?X=A.createElement(w.route.Component,null):w.route.element?X=w.route.element:X=p,A.createElement(Bp,{match:w,routeContext:{outlet:p,matches:H,isDataRoute:d!=null},children:X})};return d&&(w.route.ErrorBoundary||w.route.errorElement||B===0)?A.createElement(Up,{location:d.location,revalidation:d.revalidation,component:Q,error:k,children:Y(),routeContext:{outlet:null,matches:H,isDataRoute:!0},unstable_onError:o}):Y()},null)}function _c(s){return`${s} must be used within a data router.  See https://reactrouter.com/en/main/routers/picking-a-router.`}function kp(s){let f=A.useContext(Ol);return Ne(f,_c(s)),f}function Lp(s){let f=A.useContext(ir);return Ne(f,_c(s)),f}function qp(s){let f=A.useContext(Ft);return Ne(f,_c(s)),f}function Uc(s){let f=qp(s),d=f.matches[f.matches.length-1];return Ne(d.route.id,`${s} can only be used on routes that contain a unique "id"`),d.route.id}function Yp(){return Uc("useRouteId")}function Gp(){let s=A.useContext(Cc),f=Lp("useRouteError"),d=Uc("useRouteError");return s!==void 0?s:f.errors?.[d]}function Xp(){let{router:s}=kp("useNavigate"),f=Uc("useNavigate"),d=A.useRef(!1);return cm(()=>{d.current=!0}),A.useCallback(async(h,x={})=>{Rt(d.current,sm),d.current&&(typeof h=="number"?s.navigate(h):await s.navigate(h,{fromRouteId:f,...x}))},[s,f])}var Vf={};function um(s,f,d){!f&&!Vf[s]&&(Vf[s]=!0,Rt(!1,d))}A.memo(Qp);function Qp({routes:s,future:f,state:d,unstable_onError:o}){return om(s,void 0,d,o,f)}function Ga(s){Ne(!1,"A <Route> is only ever to be used as the child of <Routes> element, never rendered directly. Please wrap your <Route> in a <Routes>.")}function Vp({basename:s="/",children:f=null,location:d,navigationType:o="POP",navigator:h,static:x=!1}){Ne(!Bn(),"You cannot render a <Router> inside another <Router>. You should never have more than one in your app.");let S=s.replace(/^\/*/,"/"),T=A.useMemo(()=>({basename:S,navigator:h,static:x,future:{}}),[S,h,x]);typeof d=="string"&&(d=Rl(d));let{pathname:b="/",search:p="",hash:w="",state:B=null,key:k="default"}=d,M=A.useMemo(()=>{let Q=Jt(b,S);return Q==null?null:{location:{pathname:Q,search:p,hash:w,state:B,key:k},navigationType:o}},[S,b,p,w,B,k,o]);return Rt(M!=null,`<Router basename="${S}"> is not able to match the URL "${b}${p}${w}" because it does not start with the basename, so the <Router> won't render anything.`),M==null?null:A.createElement(Ot.Provider,{value:T},A.createElement(Un.Provider,{children:f,value:M}))}function Zp({children:s,location:f}){return Mp(Oc(s),f)}function Oc(s,f=[]){let d=[];return A.Children.forEach(s,(o,h)=>{if(!A.isValidElement(o))return;let x=[...f,h];if(o.type===A.Fragment){d.push.apply(d,Oc(o.props.children,x));return}Ne(o.type===Ga,`[${typeof o.type=="string"?o.type:o.type.name}] is not a <Route> component. All component children of <Routes> must be a <Route> or <React.Fragment>`),Ne(!o.props.index||!o.props.children,"An index route cannot have child routes.");let S={id:o.props.id||x.join("-"),caseSensitive:o.props.caseSensitive,element:o.props.element,Component:o.props.Component,index:o.props.index,path:o.props.path,loader:o.props.loader,action:o.props.action,hydrateFallbackElement:o.props.hydrateFallbackElement,HydrateFallback:o.props.HydrateFallback,errorElement:o.props.errorElement,ErrorBoundary:o.props.ErrorBoundary,hasErrorBoundary:o.props.hasErrorBoundary===!0||o.props.ErrorBoundary!=null||o.props.errorElement!=null,shouldRevalidate:o.props.shouldRevalidate,handle:o.props.handle,lazy:o.props.lazy};o.props.children&&(S.children=Oc(o.props.children,x)),d.push(S)}),d}var er="get",tr="application/x-www-form-urlencoded";function rr(s){return s!=null&&typeof s.tagName=="string"}function Kp(s){return rr(s)&&s.tagName.toLowerCase()==="button"}function Jp(s){return rr(s)&&s.tagName.toLowerCase()==="form"}function Fp(s){return rr(s)&&s.tagName.toLowerCase()==="input"}function Wp(s){return!!(s.metaKey||s.altKey||s.ctrlKey||s.shiftKey)}function $p(s,f){return s.button===0&&(!f||f==="_self")&&!Wp(s)}var Ii=null;function Pp(){if(Ii===null)try{new FormData(document.createElement("form"),0),Ii=!1}catch{Ii=!0}return Ii}var Ip=new Set(["application/x-www-form-urlencoded","multipart/form-data","text/plain"]);function Dc(s){return s!=null&&!Ip.has(s)?(Rt(!1,`"${s}" is not a valid \`encType\` for \`<Form>\`/\`<fetcher.Form>\` and will default to "${tr}"`),null):s}function ex(s,f){let d,o,h,x,S;if(Jp(s)){let T=s.getAttribute("action");o=T?Jt(T,f):null,d=s.getAttribute("method")||er,h=Dc(s.getAttribute("enctype"))||tr,x=new FormData(s)}else if(Kp(s)||Fp(s)&&(s.type==="submit"||s.type==="image")){let T=s.form;if(T==null)throw new Error('Cannot submit a <button> or <input type="submit"> without a <form>');let b=s.getAttribute("formaction")||T.getAttribute("action");if(o=b?Jt(b,f):null,d=s.getAttribute("formmethod")||T.getAttribute("method")||er,h=Dc(s.getAttribute("formenctype"))||Dc(T.getAttribute("enctype"))||tr,x=new FormData(T,s),!Pp()){let{name:p,type:w,value:B}=s;if(w==="image"){let k=p?`${p}.`:"";x.append(`${k}x`,"0"),x.append(`${k}y`,"0")}else p&&x.append(p,B)}}else{if(rr(s))throw new Error('Cannot submit element that is not <form>, <button>, or <input type="submit|image">');d=er,o=null,h=tr,S=s}return x&&h==="text/plain"&&(S=x,x=void 0),{action:o,method:d.toLowerCase(),encType:h,formData:x,body:S}}Object.getOwnPropertyNames(Object.prototype).sort().join("\0");function Bc(s,f){if(s===!1||s===null||typeof s>"u")throw new Error(f)}function tx(s,f,d){let o=typeof s=="string"?new URL(s,typeof window>"u"?"server://singlefetch/":window.location.origin):s;return o.pathname==="/"?o.pathname=`_root.${d}`:f&&Jt(o.pathname,f)==="/"?o.pathname=`${f.replace(/\/$/,"")}/_root.${d}`:o.pathname=`${o.pathname.replace(/\/$/,"")}.${d}`,o}async function ax(s,f){if(s.id in f)return f[s.id];try{let d=await import(s.module);return f[s.id]=d,d}catch(d){return console.error(`Error loading route module \`${s.module}\`, reloading page...`),console.error(d),window.__reactRouterContext&&window.__reactRouterContext.isSpaMode,window.location.reload(),new Promise(()=>{})}}function lx(s){return s==null?!1:s.href==null?s.rel==="preload"&&typeof s.imageSrcSet=="string"&&typeof s.imageSizes=="string":typeof s.rel=="string"&&typeof s.href=="string"}async function nx(s,f,d){let o=await Promise.all(s.map(async h=>{let x=f.routes[h.route.id];if(x){let S=await ax(x,d);return S.links?S.links():[]}return[]}));return cx(o.flat(1).filter(lx).filter(h=>h.rel==="stylesheet"||h.rel==="preload").map(h=>h.rel==="stylesheet"?{...h,rel:"prefetch",as:"style"}:{...h,rel:"prefetch"}))}function Zf(s,f,d,o,h,x){let S=(b,p)=>d[p]?b.route.id!==d[p].route.id:!0,T=(b,p)=>d[p].pathname!==b.pathname||d[p].route.path?.endsWith("*")&&d[p].params["*"]!==b.params["*"];return x==="assets"?f.filter((b,p)=>S(b,p)||T(b,p)):x==="data"?f.filter((b,p)=>{let w=o.routes[b.route.id];if(!w||!w.hasLoader)return!1;if(S(b,p)||T(b,p))return!0;if(b.route.shouldRevalidate){let B=b.route.shouldRevalidate({currentUrl:new URL(h.pathname+h.search+h.hash,window.origin),currentParams:d[0]?.params||{},nextUrl:new URL(s,window.origin),nextParams:b.params,defaultShouldRevalidate:!0});if(typeof B=="boolean")return B}return!0}):[]}function ix(s,f,{includeHydrateFallback:d}={}){return rx(s.map(o=>{let h=f.routes[o.route.id];if(!h)return[];let x=[h.module];return h.clientActionModule&&(x=x.concat(h.clientActionModule)),h.clientLoaderModule&&(x=x.concat(h.clientLoaderModule)),d&&h.hydrateFallbackModule&&(x=x.concat(h.hydrateFallbackModule)),h.imports&&(x=x.concat(h.imports)),x}).flat(1))}function rx(s){return[...new Set(s)]}function sx(s){let f={},d=Object.keys(s).sort();for(let o of d)f[o]=s[o];return f}function cx(s,f){let d=new Set;return new Set(f),s.reduce((o,h)=>{let x=JSON.stringify(sx(h));return d.has(x)||(d.add(x),o.push({key:x,link:h})),o},[])}function dm(){let s=A.useContext(Ol);return Bc(s,"You must render this element inside a <DataRouterContext.Provider> element"),s}function ox(){let s=A.useContext(ir);return Bc(s,"You must render this element inside a <DataRouterStateContext.Provider> element"),s}var Hc=A.createContext(void 0);Hc.displayName="FrameworkContext";function fm(){let s=A.useContext(Hc);return Bc(s,"You must render this element inside a <HydratedRouter> element"),s}function ux(s,f){let d=A.useContext(Hc),[o,h]=A.useState(!1),[x,S]=A.useState(!1),{onFocus:T,onBlur:b,onMouseEnter:p,onMouseLeave:w,onTouchStart:B}=f,k=A.useRef(null);A.useEffect(()=>{if(s==="render"&&S(!0),s==="viewport"){let U=Y=>{Y.forEach(X=>{S(X.isIntersecting)})},H=new IntersectionObserver(U,{threshold:.5});return k.current&&H.observe(k.current),()=>{H.disconnect()}}},[s]),A.useEffect(()=>{if(o){let U=setTimeout(()=>{S(!0)},100);return()=>{clearTimeout(U)}}},[o]);let M=()=>{h(!0)},Q=()=>{h(!1),S(!1)};return d?s!=="intent"?[x,k,{}]:[x,k,{onFocus:Mn(T,M),onBlur:Mn(b,Q),onMouseEnter:Mn(p,M),onMouseLeave:Mn(w,Q),onTouchStart:Mn(B,M)}]:[!1,k,{}]}function Mn(s,f){return d=>{s&&s(d),d.defaultPrevented||f(d)}}function dx({page:s,...f}){let{router:d}=dm(),o=A.useMemo(()=>em(d.routes,s,d.basename),[d.routes,s,d.basename]);return o?A.createElement(mx,{page:s,matches:o,...f}):null}function fx(s){let{manifest:f,routeModules:d}=fm(),[o,h]=A.useState([]);return A.useEffect(()=>{let x=!1;return nx(s,f,d).then(S=>{x||h(S)}),()=>{x=!0}},[s,f,d]),o}function mx({page:s,matches:f,...d}){let o=Wt(),{manifest:h,routeModules:x}=fm(),{basename:S}=dm(),{loaderData:T,matches:b}=ox(),p=A.useMemo(()=>Zf(s,f,b,h,o,"data"),[s,f,b,h,o]),w=A.useMemo(()=>Zf(s,f,b,h,o,"assets"),[s,f,b,h,o]),B=A.useMemo(()=>{if(s===o.pathname+o.search+o.hash)return[];let Q=new Set,U=!1;if(f.forEach(Y=>{let X=h.routes[Y.route.id];!X||!X.hasLoader||(!p.some(ee=>ee.route.id===Y.route.id)&&Y.route.id in T&&x[Y.route.id]?.shouldRevalidate||X.hasClientLoader?U=!0:Q.add(Y.route.id))}),Q.size===0)return[];let H=tx(s,S,"data");return U&&Q.size>0&&H.searchParams.set("_routes",f.filter(Y=>Q.has(Y.route.id)).map(Y=>Y.route.id).join(",")),[H.pathname+H.search]},[S,T,o,h,p,f,s,x]),k=A.useMemo(()=>ix(w,h),[w,h]),M=fx(w);return A.createElement(A.Fragment,null,B.map(Q=>A.createElement("link",{key:Q,rel:"prefetch",as:"fetch",href:Q,...d})),k.map(Q=>A.createElement("link",{key:Q,rel:"modulepreload",href:Q,...d})),M.map(({key:Q,link:U})=>A.createElement("link",{key:Q,nonce:d.nonce,...U})))}function hx(...s){return f=>{s.forEach(d=>{typeof d=="function"?d(f):d!=null&&(d.current=f)})}}var mm=typeof window<"u"&&typeof window.document<"u"&&typeof window.document.createElement<"u";try{mm&&(window.__reactRouterVersion="7.9.1")}catch{}function px({basename:s,children:f,window:d}){let o=A.useRef();o.current==null&&(o.current=ap({window:d,v5Compat:!0}));let h=o.current,[x,S]=A.useState({action:h.action,location:h.location}),T=A.useCallback(b=>{A.startTransition(()=>S(b))},[S]);return A.useLayoutEffect(()=>h.listen(T),[h,T]),A.createElement(Vp,{basename:s,children:f,location:x.location,navigationType:x.action,navigator:h})}var hm=/^(?:[a-z][a-z0-9+.-]*:|\/\/)/i,Xa=A.forwardRef(function({onClick:f,discover:d="render",prefetch:o="none",relative:h,reloadDocument:x,replace:S,state:T,target:b,to:p,preventScrollReset:w,viewTransition:B,...k},M){let{basename:Q}=A.useContext(Ot),U=typeof p=="string"&&hm.test(p),H,Y=!1;if(typeof p=="string"&&U&&(H=p,mm))try{let we=new URL(window.location.href),et=p.startsWith("//")?new URL(we.protocol+p):new URL(p),dt=Jt(et.pathname,Q);et.origin===we.origin&&dt!=null?p=dt+et.search+et.hash:Y=!0}catch{Rt(!1,`<Link to="${p}"> contains an invalid URL which will probably break when clicked - please update to a valid URL path.`)}let X=Dp(p,{relative:h}),[ee,ye,P]=ux(o,k),_e=bx(p,{replace:S,state:T,target:b,preventScrollReset:w,relative:h,viewTransition:B});function Re(we){f&&f(we),we.defaultPrevented||_e(we)}let Ue=A.createElement("a",{...k,...P,href:H||X,onClick:Y||x?f:Re,ref:hx(M,ye),target:b,"data-discover":!U&&d==="render"?"true":void 0});return ee&&!U?A.createElement(A.Fragment,null,Ue,A.createElement(dx,{page:X})):Ue});Xa.displayName="Link";var xx=A.forwardRef(function({"aria-current":f="page",caseSensitive:d=!1,className:o="",end:h=!1,style:x,to:S,viewTransition:T,children:b,...p},w){let B=Hn(S,{relative:p.relative}),k=Wt(),M=A.useContext(ir),{navigator:Q,basename:U}=A.useContext(Ot),H=M!=null&&Sx(B)&&T===!0,Y=Q.encodeLocation?Q.encodeLocation(B).pathname:B.pathname,X=k.pathname,ee=M&&M.navigation&&M.navigation.location?M.navigation.location.pathname:null;d||(X=X.toLowerCase(),ee=ee?ee.toLowerCase():null,Y=Y.toLowerCase()),ee&&U&&(ee=Jt(ee,U)||ee);const ye=Y!=="/"&&Y.endsWith("/")?Y.length-1:Y.length;let P=X===Y||!h&&X.startsWith(Y)&&X.charAt(ye)==="/",_e=ee!=null&&(ee===Y||!h&&ee.startsWith(Y)&&ee.charAt(Y.length)==="/"),Re={isActive:P,isPending:_e,isTransitioning:H},Ue=P?f:void 0,we;typeof o=="function"?we=o(Re):we=[o,P?"active":null,_e?"pending":null,H?"transitioning":null].filter(Boolean).join(" ");let et=typeof x=="function"?x(Re):x;return A.createElement(Xa,{...p,"aria-current":Ue,className:we,ref:w,style:et,to:S,viewTransition:T},typeof b=="function"?b(Re):b)});xx.displayName="NavLink";var gx=A.forwardRef(({discover:s="render",fetcherKey:f,navigate:d,reloadDocument:o,replace:h,state:x,method:S=er,action:T,onSubmit:b,relative:p,preventScrollReset:w,viewTransition:B,...k},M)=>{let Q=Nx(),U=wx(T,{relative:p}),H=S.toLowerCase()==="get"?"get":"post",Y=typeof T=="string"&&hm.test(T),X=ee=>{if(b&&b(ee),ee.defaultPrevented)return;ee.preventDefault();let ye=ee.nativeEvent.submitter,P=ye?.getAttribute("formmethod")||S;Q(ye||ee.currentTarget,{fetcherKey:f,method:P,navigate:d,replace:h,state:x,relative:p,preventScrollReset:w,viewTransition:B})};return A.createElement("form",{ref:M,method:H,action:U,onSubmit:o?b:X,...k,"data-discover":!Y&&s==="render"?"true":void 0})});gx.displayName="Form";function vx(s){return`${s} must be used within a data router.  See https://reactrouter.com/en/main/routers/picking-a-router.`}function pm(s){let f=A.useContext(Ol);return Ne(f,vx(s)),f}function bx(s,{target:f,replace:d,state:o,preventScrollReset:h,relative:x,viewTransition:S}={}){let T=Rp(),b=Wt(),p=Hn(s,{relative:x});return A.useCallback(w=>{if($p(w,f)){w.preventDefault();let B=d!==void 0?d:_n(b)===_n(p);T(s,{replace:B,state:o,preventScrollReset:h,relative:x,viewTransition:S})}},[b,T,p,d,o,f,s,h,x,S])}var yx=0,jx=()=>`__${String(++yx)}__`;function Nx(){let{router:s}=pm("useSubmit"),{basename:f}=A.useContext(Ot),d=Yp();return A.useCallback(async(o,h={})=>{let{action:x,method:S,encType:T,formData:b,body:p}=ex(o,f);if(h.navigate===!1){let w=h.fetcherKey||jx();await s.fetch(w,d,h.action||x,{preventScrollReset:h.preventScrollReset,formData:b,body:p,formMethod:h.method||S,formEncType:h.encType||T,flushSync:h.flushSync})}else await s.navigate(h.action||x,{preventScrollReset:h.preventScrollReset,formData:b,body:p,formMethod:h.method||S,formEncType:h.encType||T,replace:h.replace,state:h.state,fromRouteId:d,flushSync:h.flushSync,viewTransition:h.viewTransition})},[s,f,d])}function wx(s,{relative:f}={}){let{basename:d}=A.useContext(Ot),o=A.useContext(Ft);Ne(o,"useFormAction must be used inside a RouteContext");let[h]=o.matches.slice(-1),x={...Hn(s||".",{relative:f})},S=Wt();if(s==null){x.search=S.search;let T=new URLSearchParams(x.search),b=T.getAll("index");if(b.some(w=>w==="")){T.delete("index"),b.filter(B=>B).forEach(B=>T.append("index",B));let w=T.toString();x.search=w?`?${w}`:""}}return(!s||s===".")&&h.route.index&&(x.search=x.search?x.search.replace(/^\?/,"?index&"):"?index"),d!=="/"&&(x.pathname=x.pathname==="/"?d:Kt([d,x.pathname])),_n(x)}function Sx(s,{relative:f}={}){let d=A.useContext(rm);Ne(d!=null,"`useViewTransitionState` must be used within `react-router-dom`'s `RouterProvider`.  Did you accidentally import `RouterProvider` from `react-router`?");let{basename:o}=pm("useViewTransitionState"),h=Hn(s,{relative:f});if(!d.isTransitioning)return!1;let x=Jt(d.currentLocation.pathname,o)||d.currentLocation.pathname,S=Jt(d.nextLocation.pathname,o)||d.nextLocation.pathname;return ar(h.pathname,S)!=null||ar(h.pathname,x)!=null}const Ex="/assets/Screenshot_20250920-003837-removebg-preview-DldVoMcW.png",zx=()=>{const[s,f]=A.useState(!1),[d,o]=A.useState(!1),h=Wt(),x=()=>{f(!1)};A.useEffect(()=>{const b=()=>{window.scrollY>10?o(!0):o(!1)};return window.addEventListener("scroll",b),()=>window.removeEventListener("scroll",b)},[]);const S=[{path:"/",label:"Home"},{path:"/about",label:"About"},{path:"/services",label:"Services"},{path:"/team",label:"Portfolio"},{path:"/contact",label:"Contact"}],T=b=>h.pathname===b;return i.jsxs("div",{children:[i.jsx("nav",{className:`navbar fixed w-full z-50 transition-all duration-300 ${d?"bg-black/95 backdrop-blur-md shadow-xl py-1":"bg-transparent py-2"}`,style:{backgroundColor:"#101828"},children:i.jsxs("div",{className:"max-w-7xl mx-auto px-3 sm:px-4 lg:px-8",children:[i.jsxs("div",{className:"flex items-center justify-between h-14 md:h-16 lg:h-20",children:[i.jsx(Xa,{to:"/",className:"flex-shrink-0 z-10",onClick:x,children:i.jsx("div",{className:"logo-container group",children:i.jsx("img",{src:Ex,className:"logo-image transition-all duration-300 group-hover:scale-105 group-hover:rotate-1",alt:"Resicode Logo",style:{height:"50px",width:"auto",filter:"drop-shadow(0 1px 2px rgba(0,0,0,0.5))"}})})}),i.jsx("div",{className:"hidden lg:flex flex-1 items-center justify-center",children:i.jsx("div",{className:"flex items-center space-x-1 bg-gray-900/50 backdrop-blur-sm rounded-full p-1 border border-gray-800",children:S.map(b=>i.jsxs(Xa,{to:b.path,className:`nav-link relative px-5 py-2.5 rounded-full text-sm font-medium transition-all duration-200 ${T(b.path)?"text-white bg-gradient-to-r from-purple-600 to-pink-600 shadow-md":"text-gray-300 hover:text-white hover:bg-gray-800/50"}`,onClick:x,children:[b.label,T(b.path)&&i.jsx("span",{className:"absolute -bottom-1 left-1/2 transform -translate-x-1/2 w-1.5 h-1.5 bg-yellow-400 rounded-full animate-pulse"})]},b.path))})}),i.jsx("div",{className:"hidden lg:block flex-shrink-0",children:i.jsx(Xa,{to:"/careers",children:i.jsxs("button",{type:"button",className:"careers-btn group relative px-6 py-2.5 rounded-full text-white font-bold text-sm tracking-wider transition-all duration-300 ease-out transform hover:scale-105 hover:shadow-xl overflow-hidden",onClick:x,children:[i.jsx("div",{className:"absolute inset-0 bg-gradient-to-r from-yellow-500 via-orange-500 to-pink-500 rounded-full opacity-100 group-hover:opacity-90 transition-opacity duration-300"}),i.jsx("div",{className:"absolute inset-0 bg-gradient-to-r from-transparent via-white/20 to-transparent -translate-x-full group-hover:translate-x-full transition-transform duration-700"}),i.jsxs("span",{className:"relative flex items-center",children:[i.jsx("svg",{className:"w-3.5 h-3.5 mr-1.5 transition-transform duration-200 group-hover:rotate-12",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",xmlns:"http://www.w3.org/2000/svg",children:i.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:"2",d:"M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2 2v2m4 6h.01M5 20h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"})}),"Careers"]})]})})}),i.jsx("div",{className:"lg:hidden flex items-center",children:i.jsx("button",{type:"button",onClick:()=>f(!s),className:"inline-flex items-center justify-center p-1.5 rounded-full text-gray-400 hover:text-white hover:bg-gray-800 transition-all duration-200 focus:outline-none","aria-label":"Toggle menu","aria-expanded":s,children:i.jsx("svg",{className:`w-5 h-5 transform transition-transform duration-200 ${s?"rotate-180":""}`,fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:s?i.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:"2",d:"M6 18L18 6M6 6l12 12"}):i.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:"2",d:"M4 6h16M4 12h16M4 18h16"})})})})]}),i.jsx("div",{className:`lg:hidden transition-all duration-200 ease-in-out ${s?"max-h-80 opacity-100 mt-1":"max-h-0 opacity-0 overflow-hidden"}`,children:i.jsxs("div",{className:"px-2 pt-1 pb-2 space-y-0.5 bg-gray-900/95 backdrop-blur-lg rounded-lg border border-gray-800 shadow-lg",children:[S.map(b=>i.jsx(Xa,{to:b.path,className:`nav-link-mobile block px-3 py-2 rounded-md text-sm font-medium transition-all duration-150 ${T(b.path)?"text-white bg-gradient-to-r from-purple-600 to-pink-600":"text-gray-300 hover:text-white hover:bg-gray-800/50"}`,onClick:x,children:i.jsxs("div",{className:"flex items-center",children:[i.jsx("span",{className:"flex-1",children:b.label}),T(b.path)&&i.jsx("span",{className:"w-1.5 h-1.5 bg-yellow-400 rounded-full animate-pulse"})]})},b.path)),i.jsx(Xa,{to:"/careers",onClick:x,children:i.jsxs("button",{type:"button",className:"w-full mt-2 px-4 py-2.5 rounded-lg text-white font-bold text-sm bg-gradient-to-r from-yellow-500 via-orange-500 to-pink-500 hover:from-yellow-600 hover:via-orange-600 hover:to-pink-600 transition-all duration-200 transform hover:scale-[1.02] shadow-md flex items-center justify-center",children:[i.jsx("svg",{className:"w-4 h-4 mr-1.5",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",xmlns:"http://www.w3.org/2000/svg",children:i.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:"2",d:"M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2 2v2m4 6h.01M5 20h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"})}),"Careers"]})})]})})]})}),i.jsx("div",{className:"nav-spacer",style:{height:"56px"}}),i.jsx("style",{jsx:!0,children:`
        .navbar {
